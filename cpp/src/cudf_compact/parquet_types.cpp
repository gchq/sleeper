...
namespace format {
    ...
    const char *
      _kTypeNames[] = { "BOOLEAN", "INT32", "INT64", "INT96", "FLOAT", "DOUBLE", "BYTE_ARRAY", "FIXED_LEN_BYTE_ARRAY" };
    ...
    const std::map<int, const char *> _FieldRepetitionType_VALUES_TO_NAMES(
      ::apache::thrift::TEnumIterator(3, _kFieldRepetitionTypeValues, _kFieldRepetitionTypeNames),
      ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
    ...
    int _kCompressionCodecValues[] = { CompressionCodec::UNCOMPRESSED,
    ...
    const char
      *_kCompressionCodecNames[] = { "UNCOMPRESSED", "SNAPPY", "GZIP", "LZO", "BROTLI", "LZ4", "ZSTD", "LZ4_RAW" };
    ...
    int _kPageTypeValues[] = { PageType::DATA_PAGE,
        PageType::INDEX_PAGE,
        PageType::DICTIONARY_PAGE,
        PageType::DATA_PAGE_V2 };
    const char *_kPageTypeNames[] = { "DATA_PAGE", "INDEX_PAGE", "DICTIONARY_PAGE", "DATA_PAGE_V2" };
    ...
    int _kBoundaryOrderValues[] = { BoundaryOrder::UNORDERED, BoundaryOrder::ASCENDING, BoundaryOrder::DESCENDING };
    ...
    uint32_t SizeStatistics::write(::apache::thrift::protocol::TProtocol *oprot) const
    {
        ...
        if (this->__isset.repetition_level_histogram) {
            xfer += oprot->writeFieldBegin("repetition_level_histogram", ::apache::thrift::protocol::T_LIST, 2);
            {
                xfer += oprot->writeListBegin(
                  ::apache::thrift::protocol::T_I64, static_cast<uint32_t>(this->repetition_level_histogram.size()));
                std::vector<int64_t>::const_iterator _iter10;
                for (_iter10 = this->repetition_level_histogram.begin();
                     _iter10 != this->repetition_level_histogram.end();
                     ++_iter10) {
        ...
        if (this->__isset.definition_level_histogram) {
            ...
            {
                xfer += oprot->writeListBegin(
                  ::apache::thrift::protocol::T_I64, static_cast<uint32_t>(this->definition_level_histogram.size()));
                std::vector<int64_t>::const_iterator _iter11;
                for (_iter11 = this->definition_level_histogram.begin();
                     _iter11 != this->definition_level_histogram.end();
                     ++_iter11) {
    ...
    void SizeStatistics::printTo(std::ostream &out) const
    {
        ...
        (__isset.unencoded_byte_array_data_bytes ? (out << to_string(unencoded_byte_array_data_bytes))
                                                 : (out << "<null>"));
        out << ", " << "repetition_level_histogram=";
        (__isset.repetition_level_histogram ? (out << to_string(repetition_level_histogram)) : (out << "<null>"));
        out << ", " << "definition_level_histogram=";
        (__isset.definition_level_histogram ? (out << to_string(definition_level_histogram)) : (out << "<null>"));
        out << ")";
    }
    ...
    StringType::StringType(const StringType &other16) noexcept { (void)other16; }
    ...
    UUIDType::UUIDType(const UUIDType &other18) noexcept { (void)other18; }
    ...
    MapType::MapType(const MapType &other20) noexcept { (void)other20; }
    ...
    ListType::ListType(const ListType &other22) noexcept { (void)other22; }
    ...
    EnumType::EnumType(const EnumType &other24) noexcept { (void)other24; }
    ...
    DateType::DateType(const DateType &other26) noexcept { (void)other26; }
    ...
    NullType::NullType(const NullType &other28) noexcept { (void)other28; }
    NullType &NullType::operator=(const NullType &other29) noexcept
    {
        (void)other29;
        return *this;
    }
    ...
    DecimalType::DecimalType(const DecimalType &other30) noexcept
    {
        scale = other30.scale;
        precision = other30.precision;
    }
    DecimalType &DecimalType::operator=(const DecimalType &other31) noexcept
    {
        scale = other31.scale;
        precision = other31.precision;
        return *this;
    }
    ...
    MilliSeconds::MilliSeconds(const MilliSeconds &other32) noexcept { (void)other32; }
    MilliSeconds &MilliSeconds::operator=(const MilliSeconds &other33) noexcept
    {
        (void)other33;
        return *this;
    }
    ...
    MicroSeconds::MicroSeconds(const MicroSeconds &other34) noexcept { (void)other34; }
    MicroSeconds &MicroSeconds::operator=(const MicroSeconds &other35) noexcept
    {
        (void)other35;
        return *this;
    }
    ...
    NanoSeconds::NanoSeconds(const NanoSeconds &other36) noexcept { (void)other36; }
    NanoSeconds &NanoSeconds::operator=(const NanoSeconds &other37) noexcept
    {
        (void)other37;
        return *this;
    }
    ...
    TimeUnit::TimeUnit(const TimeUnit &other38) noexcept
    {
        MILLIS = other38.MILLIS;
        MICROS = other38.MICROS;
        NANOS = other38.NANOS;
        __isset = other38.__isset;
    }
    TimeUnit &TimeUnit::operator=(const TimeUnit &other39) noexcept
    {
        MILLIS = other39.MILLIS;
        MICROS = other39.MICROS;
        NANOS = other39.NANOS;
    ...
    TimestampType::TimestampType(const TimestampType &other40) noexcept
    {
        isAdjustedToUTC = other40.isAdjustedToUTC;
        unit = other40.unit;
    }
    TimestampType &TimestampType::operator=(const TimestampType &other41) noexcept
    {
        isAdjustedToUTC = other41.isAdjustedToUTC;
        unit = other41.unit;
        return *this;
    }
    ...
    TimeType::TimeType(const TimeType &other42) noexcept
    {
        isAdjustedToUTC = other42.isAdjustedToUTC;
        unit = other42.unit;
    }
    TimeType &TimeType::operator=(const TimeType &other43) noexcept
    {
    ...
    IntType::IntType(const IntType &other44) noexcept
    {
        bitWidth = other44.bitWidth;
        isSigned = other44.isSigned;
    }
    IntType &IntType::operator=(const IntType &other45) noexcept
    {
        bitWidth = other45.bitWidth;
        isSigned = other45.isSigned;
        return *this;
    }
    ...
    JsonType::JsonType(const JsonType &other46) noexcept { (void)other46; }
    JsonType &JsonType::operator=(const JsonType &other47) noexcept
    {
        (void)other47;
        return *this;
    }
    ...
    BsonType::BsonType(const BsonType &other48) noexcept { (void)other48; }
    BsonType &BsonType::operator=(const BsonType &other49) noexcept
    {
        (void)other49;
        return *this;
    }
    ...
    LogicalType::LogicalType(const LogicalType &other50) noexcept
    {
        STRING = other50.STRING;
        MAP = other50.MAP;
        LIST = other50.LIST;
        ENUM = other50.ENUM;
        DECIMAL = other50.DECIMAL;
        DATE = other50.DATE;
        TIME = other50.TIME;
        TIMESTAMP = other50.TIMESTAMP;
        INTEGER = other50.INTEGER;
        UNKNOWN = other50.UNKNOWN;
        JSON = other50.JSON;
        BSON = other50.BSON;
        UUID = other50.UUID;
        __isset = other50.__isset;
    }
    LogicalType &LogicalType::operator=(const LogicalType &other51) noexcept
    {
        STRING = other51.STRING;
        MAP = other51.MAP;
        LIST = other51.LIST;
        ENUM = other51.ENUM;
        DECIMAL = other51.DECIMAL;
        DATE = other51.DATE;
        TIME = other51.TIME;
        TIMESTAMP = other51.TIMESTAMP;
        INTEGER = other51.INTEGER;
        UNKNOWN = other51.UNKNOWN;
        JSON = other51.JSON;
        BSON = other51.BSON;
        UUID = other51.UUID;
        ...
        while (true) {
            ...
            case 1:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->type = static_cast<Type::type>(ecast52);
            ...
            case 3:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->repetition_type = static_cast<FieldRepetitionType::type>(ecast53);
            ...
            case 6:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->converted_type = static_cast<ConvertedType::type>(ecast54);
    ...
    SchemaElement::SchemaElement(const SchemaElement &other55)
    {
        type = other55.type;
        type_length = other55.type_length;
        repetition_type = other55.repetition_type;
        name = other55.name;
        num_children = other55.num_children;
        converted_type = other55.converted_type;
        scale = other55.scale;
        precision = other55.precision;
        field_id = other55.field_id;
        logicalType = other55.logicalType;
        __isset = other55.__isset;
    }
    SchemaElement &SchemaElement::operator=(const SchemaElement &other56)
    {
        type = other56.type;
        type_length = other56.type_length;
        repetition_type = other56.repetition_type;
        name = other56.name;
        num_children = other56.num_children;
        converted_type = other56.converted_type;
        scale = other56.scale;
        precision = other56.precision;
        field_id = other56.field_id;
        logicalType = other56.logicalType;
    ...
    void DataPageHeader::__set_encoding(const Encoding::type val) { this->encoding = val; }
    ...
    uint32_t DataPageHeader::read(::apache::thrift::protocol::TProtocol *iprot)
    {
        ...
        while (true) {
            ...
            case 2:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->encoding = static_cast<Encoding::type>(ecast57);
                    isset_encoding = true;
                } else {
                    xfer += iprot->skip(ftype);
                }
            ...
            case 3:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->definition_level_encoding = static_cast<Encoding::type>(ecast58);
            ...
            case 4:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->repetition_level_encoding = static_cast<Encoding::type>(ecast59);
        ...
        if (!isset_definition_level_encoding) throw TProtocolException(TProtocolException::INVALID_DATA);
        if (!isset_repetition_level_encoding) throw TProtocolException(TProtocolException::INVALID_DATA);
        return xfer;
    }
    ...
    DataPageHeader::DataPageHeader(const DataPageHeader &other60)
    {
        num_values = other60.num_values;
        encoding = other60.encoding;
        definition_level_encoding = other60.definition_level_encoding;
        repetition_level_encoding = other60.repetition_level_encoding;
        statistics = other60.statistics;
        __isset = other60.__isset;
    }
    DataPageHeader &DataPageHeader::operator=(const DataPageHeader &other61)
    {
        num_values = other61.num_values;
        encoding = other61.encoding;
        definition_level_encoding = other61.definition_level_encoding;
        repetition_level_encoding = other61.repetition_level_encoding;
        statistics = other61.statistics;
    ...
    IndexPageHeader::IndexPageHeader(const IndexPageHeader &other62) noexcept { (void)other62; }
    IndexPageHeader &IndexPageHeader::operator=(const IndexPageHeader &other63) noexcept
    {
        (void)other63;
        return *this;
    }
    ...
    void DictionaryPageHeader::__set_encoding(const Encoding::type val) { this->encoding = val; }
        ...
        while (true) {
            ...
            case 2:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->encoding = static_cast<Encoding::type>(ecast64);
                    isset_encoding = true;
                } else {
                    xfer += iprot->skip(ftype);
                }
    ...
    DictionaryPageHeader::DictionaryPageHeader(const DictionaryPageHeader &other65) noexcept
    {
        num_values = other65.num_values;
        encoding = other65.encoding;
        is_sorted = other65.is_sorted;
        __isset = other65.__isset;
    }
    DictionaryPageHeader &DictionaryPageHeader::operator=(const DictionaryPageHeader &other66) noexcept
    {
        num_values = other66.num_values;
        encoding = other66.encoding;
        is_sorted = other66.is_sorted;
    ...
    void DataPageHeaderV2::__set_encoding(const Encoding::type val) { this->encoding = val; }
    ...
    uint32_t DataPageHeaderV2::read(::apache::thrift::protocol::TProtocol *iprot)
    {
        ...
        while (true) {
            ...
            case 4:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->encoding = static_cast<Encoding::type>(ecast67);
                    isset_encoding = true;
                } else {
                    xfer += iprot->skip(ftype);
                }
        ...
        if (!isset_encoding) throw TProtocolException(TProtocolException::INVALID_DATA);
        if (!isset_definition_levels_byte_length) throw TProtocolException(TProtocolException::INVALID_DATA);
        if (!isset_repetition_levels_byte_length) throw TProtocolException(TProtocolException::INVALID_DATA);
        return xfer;
    }
    ...
    DataPageHeaderV2::DataPageHeaderV2(const DataPageHeaderV2 &other68)
    {
        num_values = other68.num_values;
        num_nulls = other68.num_nulls;
        num_rows = other68.num_rows;
        encoding = other68.encoding;
        definition_levels_byte_length = other68.definition_levels_byte_length;
        repetition_levels_byte_length = other68.repetition_levels_byte_length;
        is_compressed = other68.is_compressed;
        statistics = other68.statistics;
        __isset = other68.__isset;
    }
    DataPageHeaderV2 &DataPageHeaderV2::operator=(const DataPageHeaderV2 &other69)
    {
        num_values = other69.num_values;
        num_nulls = other69.num_nulls;
        num_rows = other69.num_rows;
        encoding = other69.encoding;
        definition_levels_byte_length = other69.definition_levels_byte_length;
        repetition_levels_byte_length = other69.repetition_levels_byte_length;
        is_compressed = other69.is_compressed;
        statistics = other69.statistics;
    ...
    SplitBlockAlgorithm::SplitBlockAlgorithm(const SplitBlockAlgorithm &other70) noexcept { (void)other70; }
    SplitBlockAlgorithm &SplitBlockAlgorithm::operator=(const SplitBlockAlgorithm &other71) noexcept
    {
        (void)other71;
        return *this;
    }
    ...
    BloomFilterAlgorithm::BloomFilterAlgorithm(const BloomFilterAlgorithm &other72) noexcept
    {
        BLOCK = other72.BLOCK;
        __isset = other72.__isset;
    }
    BloomFilterAlgorithm &BloomFilterAlgorithm::operator=(const BloomFilterAlgorithm &other73) noexcept
    {
        BLOCK = other73.BLOCK;
    ...
    XxHash::XxHash(const XxHash &other74) noexcept { (void)other74; }
    XxHash &XxHash::operator=(const XxHash &other75) noexcept
    {
        (void)other75;
        return *this;
    }
    ...
    BloomFilterHash::BloomFilterHash(const BloomFilterHash &other76) noexcept
    {
        XXHASH = other76.XXHASH;
        __isset = other76.__isset;
    }
    BloomFilterHash &BloomFilterHash::operator=(const BloomFilterHash &other77) noexcept
    {
        XXHASH = other77.XXHASH;
    ...
    Uncompressed::Uncompressed(const Uncompressed &other78) noexcept { (void)other78; }
    Uncompressed &Uncompressed::operator=(const Uncompressed &other79) noexcept
    {
        (void)other79;
        return *this;
    }
    ...
    BloomFilterCompression::BloomFilterCompression(const BloomFilterCompression &other80) noexcept
    {
        UNCOMPRESSED = other80.UNCOMPRESSED;
        __isset = other80.__isset;
    }
    BloomFilterCompression &BloomFilterCompression::operator=(const BloomFilterCompression &other81) noexcept
    {
        UNCOMPRESSED = other81.UNCOMPRESSED;
    ...
    void BloomFilterHeader::__set_algorithm(const BloomFilterAlgorithm &val) { this->algorithm = val; }

    void BloomFilterHeader::__set_hash(const BloomFilterHash &val) { this->hash = val; }

    void BloomFilterHeader::__set_compression(const BloomFilterCompression &val) { this->compression = val; }
    ...
    BloomFilterHeader::BloomFilterHeader(const BloomFilterHeader &other82) noexcept
    {
        numBytes = other82.numBytes;
        algorithm = other82.algorithm;
        hash = other82.hash;
        compression = other82.compression;
    }
    BloomFilterHeader &BloomFilterHeader::operator=(const BloomFilterHeader &other83) noexcept
    {
        numBytes = other83.numBytes;
        algorithm = other83.algorithm;
        hash = other83.hash;
        compression = other83.compression;
        return *this;
    }
    ...
    void PageHeader::__set_type(const PageType::type val) { this->type = val; }

    void PageHeader::__set_uncompressed_page_size(const int32_t val) { this->uncompressed_page_size = val; }

    void PageHeader::__set_compressed_page_size(const int32_t val) { this->compressed_page_size = val; }
    ...
    uint32_t PageHeader::read(::apache::thrift::protocol::TProtocol *iprot)
    {
        ...
        while (true) {
            ...
            case 1:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->type = static_cast<PageType::type>(ecast84);
                    isset_type = true;
                } else {
                    xfer += iprot->skip(ftype);
                }
        ...
        if (!isset_uncompressed_page_size) throw TProtocolException(TProtocolException::INVALID_DATA);
        if (!isset_compressed_page_size) throw TProtocolException(TProtocolException::INVALID_DATA);
        return xfer;
    }
    ...
    PageHeader::PageHeader(const PageHeader &other85)
    {
        type = other85.type;
        uncompressed_page_size = other85.uncompressed_page_size;
        compressed_page_size = other85.compressed_page_size;
        crc = other85.crc;
        data_page_header = other85.data_page_header;
        index_page_header = other85.index_page_header;
        dictionary_page_header = other85.dictionary_page_header;
        data_page_header_v2 = other85.data_page_header_v2;
        __isset = other85.__isset;
    }
    PageHeader &PageHeader::operator=(const PageHeader &other86)
    {
        type = other86.type;
        uncompressed_page_size = other86.uncompressed_page_size;
        compressed_page_size = other86.compressed_page_size;
        crc = other86.crc;
        data_page_header = other86.data_page_header;
        index_page_header = other86.index_page_header;
        dictionary_page_header = other86.dictionary_page_header;
        data_page_header_v2 = other86.data_page_header_v2;
    ...
    void PageHeader::printTo(std::ostream &out) const
    {
        ...
        (__isset.dictionary_page_header ? (out << to_string(dictionary_page_header)) : (out << "<null>"));
        out << ", " << "data_page_header_v2=";
        (__isset.data_page_header_v2 ? (out << to_string(data_page_header_v2)) : (out << "<null>"));
        out << ")";
    }
    ...
    KeyValue::KeyValue(const KeyValue &other87)
    {
        key = other87.key;
        value = other87.value;
        __isset = other87.__isset;
    }
    KeyValue &KeyValue::operator=(const KeyValue &other88)
    {
        key = other88.key;
        value = other88.value;
    ...
    SortingColumn::SortingColumn(const SortingColumn &other89) noexcept
    {
        column_idx = other89.column_idx;
        descending = other89.descending;
        nulls_first = other89.nulls_first;
    }
    SortingColumn &SortingColumn::operator=(const SortingColumn &other90) noexcept
    {
        column_idx = other90.column_idx;
        descending = other90.descending;
        nulls_first = other90.nulls_first;
        return *this;
    }
    ...
    void PageEncodingStats::__set_page_type(const PageType::type val) { this->page_type = val; }

    void PageEncodingStats::__set_encoding(const Encoding::type val) { this->encoding = val; }
        ...
        while (true) {
            ...
            case 1:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->page_type = static_cast<PageType::type>(ecast91);
            ...
            case 2:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->encoding = static_cast<Encoding::type>(ecast92);
                    isset_encoding = true;
                } else {
                    xfer += iprot->skip(ftype);
                }
    ...
    PageEncodingStats::PageEncodingStats(const PageEncodingStats &other93) noexcept
    {
        page_type = other93.page_type;
        encoding = other93.encoding;
        count = other93.count;
    }
    PageEncodingStats &PageEncodingStats::operator=(const PageEncodingStats &other94) noexcept
    {
        page_type = other94.page_type;
        encoding = other94.encoding;
        count = other94.count;
        return *this;
    }
    ...
    void ColumnMetaData::__set_type(const Type::type val) { this->type = val; }

    void ColumnMetaData::__set_encodings(const std::vector<Encoding::type> &val) { this->encodings = val; }

    void ColumnMetaData::__set_path_in_schema(const std::vector<std::string> &val) { this->path_in_schema = val; }

    void ColumnMetaData::__set_codec(const CompressionCodec::type val) { this->codec = val; }

    void ColumnMetaData::__set_num_values(const int64_t val) { this->num_values = val; }

    void ColumnMetaData::__set_total_uncompressed_size(const int64_t val) { this->total_uncompressed_size = val; }

    void ColumnMetaData::__set_total_compressed_size(const int64_t val) { this->total_compressed_size = val; }
    ...
    void ColumnMetaData::__set_data_page_offset(const int64_t val) { this->data_page_offset = val; }
    ...
    uint32_t ColumnMetaData::read(::apache::thrift::protocol::TProtocol *iprot)
    {
        ...
        while (true) {
            ...
            case 1:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->type = static_cast<Type::type>(ecast95);
                    isset_type = true;
                } else {
                    xfer += iprot->skip(ftype);
                }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->encodings.resize(_size96);
                        uint32_t _i100;
                        for (_i100 = 0; _i100 < _size96; ++_i100) {
                            int32_t ecast101;
                            xfer += iprot->readI32(ecast101);
                            this->encodings[_i100] = static_cast<Encoding::type>(ecast101);
                        }
                        xfer += iprot->readListEnd();
                    }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->path_in_schema.resize(_size102);
                        uint32_t _i106;
                        for (_i106 = 0; _i106 < _size102; ++_i106) {
                            xfer += iprot->readString(this->path_in_schema[_i106]);
                        }
                        xfer += iprot->readListEnd();
                    }
            ...
            case 4:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->codec = static_cast<CompressionCodec::type>(ecast107);
                    isset_codec = true;
                } else {
                    xfer += iprot->skip(ftype);
                }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->key_value_metadata.resize(_size108);
                        uint32_t _i112;
                        for (_i112 = 0; _i112 < _size108; ++_i112) {
                            xfer += this->key_value_metadata[_i112].read(iprot);
                        }
                        xfer += iprot->readListEnd();
                    }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->encoding_stats.resize(_size113);
                        uint32_t _i117;
                        for (_i117 = 0; _i117 < _size113; ++_i117) { xfer += this->encoding_stats[_i117].read(iprot); }
                        xfer += iprot->readListEnd();
                    }
        ...
        if (!isset_num_values) throw TProtocolException(TProtocolException::INVALID_DATA);
        if (!isset_total_uncompressed_size) throw TProtocolException(TProtocolException::INVALID_DATA);
        if (!isset_total_compressed_size) throw TProtocolException(TProtocolException::INVALID_DATA);
    ...
    uint32_t ColumnMetaData::write(::apache::thrift::protocol::TProtocol *oprot) const
    {
        ...
        {
            xfer +=
              oprot->writeListBegin(::apache::thrift::protocol::T_I32, static_cast<uint32_t>(this->encodings.size()));
            std::vector<Encoding::type>::const_iterator _iter118;
            for (_iter118 = this->encodings.begin(); _iter118 != this->encodings.end(); ++_iter118) {
                xfer += oprot->writeI32(static_cast<int32_t>((*_iter118)));
            }
            xfer += oprot->writeListEnd();
        }
        xfer += oprot->writeFieldEnd();
        ...
        {
            xfer += oprot->writeListBegin(
              ::apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->path_in_schema.size()));
            std::vector<std::string>::const_iterator _iter119;
            for (_iter119 = this->path_in_schema.begin(); _iter119 != this->path_in_schema.end(); ++_iter119) {
        ...
        if (this->__isset.key_value_metadata) {
            ...
            {
                xfer += oprot->writeListBegin(
                  ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->key_value_metadata.size()));
                std::vector<KeyValue>::const_iterator _iter120;
                for (_iter120 = this->key_value_metadata.begin(); _iter120 != this->key_value_metadata.end();
                     ++_iter120) {
        ...
        if (this->__isset.encoding_stats) {
            ...
            {
                xfer += oprot->writeListBegin(
                  ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->encoding_stats.size()));
                std::vector<PageEncodingStats>::const_iterator _iter121;
                for (_iter121 = this->encoding_stats.begin(); _iter121 != this->encoding_stats.end(); ++_iter121) {
    ...
    ColumnMetaData::ColumnMetaData(const ColumnMetaData &other122)
    {
        type = other122.type;
        encodings = other122.encodings;
        path_in_schema = other122.path_in_schema;
        codec = other122.codec;
        num_values = other122.num_values;
        total_uncompressed_size = other122.total_uncompressed_size;
        total_compressed_size = other122.total_compressed_size;
        key_value_metadata = other122.key_value_metadata;
        data_page_offset = other122.data_page_offset;
        index_page_offset = other122.index_page_offset;
        dictionary_page_offset = other122.dictionary_page_offset;
        statistics = other122.statistics;
        encoding_stats = other122.encoding_stats;
        bloom_filter_offset = other122.bloom_filter_offset;
        bloom_filter_length = other122.bloom_filter_length;
        size_statistics = other122.size_statistics;
        __isset = other122.__isset;
    }
    ColumnMetaData &ColumnMetaData::operator=(const ColumnMetaData &other123)
    {
        type = other123.type;
        encodings = other123.encodings;
        path_in_schema = other123.path_in_schema;
        codec = other123.codec;
        num_values = other123.num_values;
        total_uncompressed_size = other123.total_uncompressed_size;
        total_compressed_size = other123.total_compressed_size;
        key_value_metadata = other123.key_value_metadata;
        data_page_offset = other123.data_page_offset;
        index_page_offset = other123.index_page_offset;
        dictionary_page_offset = other123.dictionary_page_offset;
        statistics = other123.statistics;
        encoding_stats = other123.encoding_stats;
        bloom_filter_offset = other123.bloom_filter_offset;
        bloom_filter_length = other123.bloom_filter_length;
        size_statistics = other123.size_statistics;
    ...
    void ColumnMetaData::printTo(std::ostream &out) const
    {
        ...
        (__isset.key_value_metadata ? (out << to_string(key_value_metadata)) : (out << "<null>"));
        ...
        (__isset.dictionary_page_offset ? (out << to_string(dictionary_page_offset)) : (out << "<null>"));
        out << ", " << "statistics=";
        (__isset.statistics ? (out << to_string(statistics)) : (out << "<null>"));
        out << ", " << "encoding_stats=";
        (__isset.encoding_stats ? (out << to_string(encoding_stats)) : (out << "<null>"));
        out << ", " << "bloom_filter_offset=";
        (__isset.bloom_filter_offset ? (out << to_string(bloom_filter_offset)) : (out << "<null>"));
        out << ", " << "bloom_filter_length=";
        (__isset.bloom_filter_length ? (out << to_string(bloom_filter_length)) : (out << "<null>"));
        out << ", " << "size_statistics=";
    ...
    EncryptionWithFooterKey::EncryptionWithFooterKey(const EncryptionWithFooterKey &other124) noexcept
    {
        (void)other124;
    }
    EncryptionWithFooterKey &EncryptionWithFooterKey::operator=(const EncryptionWithFooterKey &other125) noexcept
    {
        (void)other125;
        return *this;
    }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->path_in_schema.resize(_size126);
                        uint32_t _i130;
                        for (_i130 = 0; _i130 < _size126; ++_i130) {
                            xfer += iprot->readString(this->path_in_schema[_i130]);
                        }
                        xfer += iprot->readListEnd();
                    }
                    isset_path_in_schema = true;
    ...
    uint32_t EncryptionWithColumnKey::write(::apache::thrift::protocol::TProtocol *oprot) const
    {
        ...
        xfer += oprot->writeFieldBegin("path_in_schema", ::apache::thrift::protocol::T_LIST, 1);
        {
            ...
            for (_iter131 = this->path_in_schema.begin(); _iter131 != this->path_in_schema.end(); ++_iter131) {
    ...
    EncryptionWithColumnKey::EncryptionWithColumnKey(const EncryptionWithColumnKey &other132)
    {
        path_in_schema = other132.path_in_schema;
        key_metadata = other132.key_metadata;
        __isset = other132.__isset;
    }
    EncryptionWithColumnKey &EncryptionWithColumnKey::operator=(const EncryptionWithColumnKey &other133)
    {
        path_in_schema = other133.path_in_schema;
        key_metadata = other133.key_metadata;
    ...
    ColumnCryptoMetaData::ColumnCryptoMetaData(const ColumnCryptoMetaData &other134)
    {
        ENCRYPTION_WITH_FOOTER_KEY = other134.ENCRYPTION_WITH_FOOTER_KEY;
        ENCRYPTION_WITH_COLUMN_KEY = other134.ENCRYPTION_WITH_COLUMN_KEY;
        __isset = other134.__isset;
    }
    ColumnCryptoMetaData &ColumnCryptoMetaData::operator=(const ColumnCryptoMetaData &other135)
    {
        ENCRYPTION_WITH_FOOTER_KEY = other135.ENCRYPTION_WITH_FOOTER_KEY;
        ENCRYPTION_WITH_COLUMN_KEY = other135.ENCRYPTION_WITH_COLUMN_KEY;
    ...
    void ColumnCryptoMetaData::printTo(std::ostream &out) const
    {
        ...
        (__isset.ENCRYPTION_WITH_FOOTER_KEY ? (out << to_string(ENCRYPTION_WITH_FOOTER_KEY)) : (out << "<null>"));
        out << ", " << "ENCRYPTION_WITH_COLUMN_KEY=";
        (__isset.ENCRYPTION_WITH_COLUMN_KEY ? (out << to_string(ENCRYPTION_WITH_COLUMN_KEY)) : (out << "<null>"));
        out << ")";
    }
    ...
    ColumnChunk::ColumnChunk(const ColumnChunk &other136)
    {
        file_path = other136.file_path;
        file_offset = other136.file_offset;
        meta_data = other136.meta_data;
        offset_index_offset = other136.offset_index_offset;
        offset_index_length = other136.offset_index_length;
        column_index_offset = other136.column_index_offset;
        column_index_length = other136.column_index_length;
        crypto_metadata = other136.crypto_metadata;
        encrypted_column_metadata = other136.encrypted_column_metadata;
        __isset = other136.__isset;
    }
    ColumnChunk &ColumnChunk::operator=(const ColumnChunk &other137)
    {
        file_path = other137.file_path;
        file_offset = other137.file_offset;
        meta_data = other137.meta_data;
        offset_index_offset = other137.offset_index_offset;
        offset_index_length = other137.offset_index_length;
        column_index_offset = other137.column_index_offset;
        column_index_length = other137.column_index_length;
        crypto_metadata = other137.crypto_metadata;
        encrypted_column_metadata = other137.encrypted_column_metadata;
    ...
    void ColumnChunk::printTo(std::ostream &out) const
    {
        ...
        (__isset.offset_index_offset ? (out << to_string(offset_index_offset)) : (out << "<null>"));
        out << ", " << "offset_index_length=";
        (__isset.offset_index_length ? (out << to_string(offset_index_length)) : (out << "<null>"));
        out << ", " << "column_index_offset=";
        (__isset.column_index_offset ? (out << to_string(column_index_offset)) : (out << "<null>"));
        out << ", " << "column_index_length=";
        (__isset.column_index_length ? (out << to_string(column_index_length)) : (out << "<null>"));
        out << ", " << "crypto_metadata=";
        (__isset.crypto_metadata ? (out << to_string(crypto_metadata)) : (out << "<null>"));
        out << ", " << "encrypted_column_metadata=";
        (__isset.encrypted_column_metadata ? (out << to_string(encrypted_column_metadata)) : (out << "<null>"));
        out << ")";
    }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        uint32_t _i142;
                        for (_i142 = 0; _i142 < _size138; ++_i142) { xfer += this->columns[_i142].read(iprot); }
                        xfer += iprot->readListEnd();
                    }
                    isset_columns = true;
                } else {
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->sorting_columns.resize(_size143);
                        uint32_t _i147;
                        for (_i147 = 0; _i147 < _size143; ++_i147) { xfer += this->sorting_columns[_i147].read(iprot); }
                        xfer += iprot->readListEnd();
                    }
    ...
    uint32_t RowGroup::write(::apache::thrift::protocol::TProtocol *oprot) const
    {
        ...
        {
            xfer +=
              oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->columns.size()));
            std::vector<ColumnChunk>::const_iterator _iter148;
            for (_iter148 = this->columns.begin(); _iter148 != this->columns.end(); ++_iter148) {
        ...
        if (this->__isset.sorting_columns) {
            ...
            {
                xfer += oprot->writeListBegin(
                  ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->sorting_columns.size()));
                std::vector<SortingColumn>::const_iterator _iter149;
                for (_iter149 = this->sorting_columns.begin(); _iter149 != this->sorting_columns.end(); ++_iter149) {
    ...
    RowGroup::RowGroup(const RowGroup &other150)
    {
        columns = other150.columns;
        total_byte_size = other150.total_byte_size;
        num_rows = other150.num_rows;
        sorting_columns = other150.sorting_columns;
        file_offset = other150.file_offset;
        total_compressed_size = other150.total_compressed_size;
        ordinal = other150.ordinal;
        __isset = other150.__isset;
    }
    RowGroup &RowGroup::operator=(const RowGroup &other151)
    {
        columns = other151.columns;
        total_byte_size = other151.total_byte_size;
        num_rows = other151.num_rows;
        sorting_columns = other151.sorting_columns;
        file_offset = other151.file_offset;
        total_compressed_size = other151.total_compressed_size;
        ordinal = other151.ordinal;
    ...
    void RowGroup::printTo(std::ostream &out) const
    {
        ...
        (__isset.total_compressed_size ? (out << to_string(total_compressed_size)) : (out << "<null>"));
        out << ", " << "ordinal=";
    ...
    TypeDefinedOrder::TypeDefinedOrder(const TypeDefinedOrder &other152) noexcept { (void)other152; }
    TypeDefinedOrder &TypeDefinedOrder::operator=(const TypeDefinedOrder &other153) noexcept
    {
        (void)other153;
        return *this;
    }
    ...
    ColumnOrder::ColumnOrder(const ColumnOrder &other154) noexcept
    {
        TYPE_ORDER = other154.TYPE_ORDER;
        __isset = other154.__isset;
    }
    ColumnOrder &ColumnOrder::operator=(const ColumnOrder &other155) noexcept
    {
        TYPE_ORDER = other155.TYPE_ORDER;
    ...
    void PageLocation::__set_compressed_page_size(const int32_t val) { this->compressed_page_size = val; }

    void PageLocation::__set_first_row_index(const int64_t val) { this->first_row_index = val; }
    ...
    PageLocation::PageLocation(const PageLocation &other156) noexcept
    {
        offset = other156.offset;
        compressed_page_size = other156.compressed_page_size;
        first_row_index = other156.first_row_index;
    }
    PageLocation &PageLocation::operator=(const PageLocation &other157) noexcept
    {
        offset = other157.offset;
        compressed_page_size = other157.compressed_page_size;
        first_row_index = other157.first_row_index;
        return *this;
    }
    ...
    void OffsetIndex::__set_page_locations(const std::vector<PageLocation> &val) { this->page_locations = val; }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->page_locations.resize(_size158);
                        uint32_t _i162;
                        for (_i162 = 0; _i162 < _size158; ++_i162) { xfer += this->page_locations[_i162].read(iprot); }
                        xfer += iprot->readListEnd();
                    }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->unencoded_byte_array_data_bytes.resize(_size163);
                        uint32_t _i167;
                        for (_i167 = 0; _i167 < _size163; ++_i167) {
                            xfer += iprot->readI64(this->unencoded_byte_array_data_bytes[_i167]);
                        }
                        xfer += iprot->readListEnd();
                    }
                    this->__isset.unencoded_byte_array_data_bytes = true;
    ...
    uint32_t OffsetIndex::write(::apache::thrift::protocol::TProtocol *oprot) const
    {
        ...
        {
            xfer += oprot->writeListBegin(
              ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->page_locations.size()));
            std::vector<PageLocation>::const_iterator _iter168;
            for (_iter168 = this->page_locations.begin(); _iter168 != this->page_locations.end(); ++_iter168) {
        ...
        if (this->__isset.unencoded_byte_array_data_bytes) {
            xfer += oprot->writeFieldBegin("unencoded_byte_array_data_bytes", ::apache::thrift::protocol::T_LIST, 2);
            {
                ...
                for (_iter169 = this->unencoded_byte_array_data_bytes.begin();
                     _iter169 != this->unencoded_byte_array_data_bytes.end();
                     ++_iter169) {
    ...
    OffsetIndex::OffsetIndex(const OffsetIndex &other170)
    {
        page_locations = other170.page_locations;
        unencoded_byte_array_data_bytes = other170.unencoded_byte_array_data_bytes;
        __isset = other170.__isset;
    }
    OffsetIndex &OffsetIndex::operator=(const OffsetIndex &other171)
    {
        page_locations = other171.page_locations;
        unencoded_byte_array_data_bytes = other171.unencoded_byte_array_data_bytes;
    ...
    void ColumnIndex::__set_null_pages(const std::vector<bool> &val) { this->null_pages = val; }

    void ColumnIndex::__set_min_values(const std::vector<std::string> &val) { this->min_values = val; }

    void ColumnIndex::__set_max_values(const std::vector<std::string> &val) { this->max_values = val; }

    void ColumnIndex::__set_boundary_order(const BoundaryOrder::type val) { this->boundary_order = val; }
        ...
        while (true) {
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->null_pages.resize(_size172);
                        uint32_t _i176;
                        for (_i176 = 0; _i176 < _size172; ++_i176) { xfer += iprot->readBool(this->null_pages[_i176]); }
                        xfer += iprot->readListEnd();
                    }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->min_values.resize(_size177);
                        uint32_t _i181;
                        for (_i181 = 0; _i181 < _size177; ++_i181) {
                            xfer += iprot->readBinary(this->min_values[_i181]);
                        }
                        xfer += iprot->readListEnd();
                    }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->max_values.resize(_size182);
                        uint32_t _i186;
                        for (_i186 = 0; _i186 < _size182; ++_i186) {
                            xfer += iprot->readBinary(this->max_values[_i186]);
                        }
                        xfer += iprot->readListEnd();
                    }
            ...
            case 4:
                if (ftype == ::apache::thrift::protocol::T_I32) {
                    ...
                    this->boundary_order = static_cast<BoundaryOrder::type>(ecast187);
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->null_counts.resize(_size188);
                        uint32_t _i192;
                        for (_i192 = 0; _i192 < _size188; ++_i192) { xfer += iprot->readI64(this->null_counts[_i192]); }
                        xfer += iprot->readListEnd();
                    }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->repetition_level_histograms.resize(_size193);
                        uint32_t _i197;
                        for (_i197 = 0; _i197 < _size193; ++_i197) {
                            xfer += iprot->readI64(this->repetition_level_histograms[_i197]);
                        }
                        xfer += iprot->readListEnd();
                    }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->definition_level_histograms.resize(_size198);
                        uint32_t _i202;
                        for (_i202 = 0; _i202 < _size198; ++_i202) {
                            xfer += iprot->readI64(this->definition_level_histograms[_i202]);
                        }
                        xfer += iprot->readListEnd();
                    }
    ...
    uint32_t ColumnIndex::write(::apache::thrift::protocol::TProtocol *oprot) const
    {
        ...
        {
            xfer +=
              oprot->writeListBegin(::apache::thrift::protocol::T_BOOL, static_cast<uint32_t>(this->null_pages.size()));
            std::vector<bool>::const_iterator _iter203;
            for (_iter203 = this->null_pages.begin(); _iter203 != this->null_pages.end(); ++_iter203) {
        ...
        {
            xfer += oprot->writeListBegin(
              ::apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->min_values.size()));
            std::vector<std::string>::const_iterator _iter204;
            for (_iter204 = this->min_values.begin(); _iter204 != this->min_values.end(); ++_iter204) {
        ...
        {
            xfer += oprot->writeListBegin(
              ::apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->max_values.size()));
            std::vector<std::string>::const_iterator _iter205;
            for (_iter205 = this->max_values.begin(); _iter205 != this->max_values.end(); ++_iter205) {
        ...
        if (this->__isset.null_counts) {
            ...
            {
                xfer += oprot->writeListBegin(
                  ::apache::thrift::protocol::T_I64, static_cast<uint32_t>(this->null_counts.size()));
                std::vector<int64_t>::const_iterator _iter206;
                for (_iter206 = this->null_counts.begin(); _iter206 != this->null_counts.end(); ++_iter206) {
        ...
        if (this->__isset.repetition_level_histograms) {
            ...
            {
                xfer += oprot->writeListBegin(
                  ::apache::thrift::protocol::T_I64, static_cast<uint32_t>(this->repetition_level_histograms.size()));
                std::vector<int64_t>::const_iterator _iter207;
                for (_iter207 = this->repetition_level_histograms.begin();
                     _iter207 != this->repetition_level_histograms.end();
                     ++_iter207) {
        ...
        if (this->__isset.definition_level_histograms) {
            ...
            {
                xfer += oprot->writeListBegin(
                  ::apache::thrift::protocol::T_I64, static_cast<uint32_t>(this->definition_level_histograms.size()));
                std::vector<int64_t>::const_iterator _iter208;
                for (_iter208 = this->definition_level_histograms.begin();
                     _iter208 != this->definition_level_histograms.end();
                     ++_iter208) {
    ...
    ColumnIndex::ColumnIndex(const ColumnIndex &other209)
    {
        null_pages = other209.null_pages;
        min_values = other209.min_values;
        max_values = other209.max_values;
        boundary_order = other209.boundary_order;
        null_counts = other209.null_counts;
        repetition_level_histograms = other209.repetition_level_histograms;
        definition_level_histograms = other209.definition_level_histograms;
        __isset = other209.__isset;
    }
    ColumnIndex &ColumnIndex::operator=(const ColumnIndex &other210)
    {
        null_pages = other210.null_pages;
        min_values = other210.min_values;
        max_values = other210.max_values;
        boundary_order = other210.boundary_order;
        null_counts = other210.null_counts;
        repetition_level_histograms = other210.repetition_level_histograms;
        definition_level_histograms = other210.definition_level_histograms;
    ...
    void ColumnIndex::printTo(std::ostream &out) const
    {
        ...
        (__isset.repetition_level_histograms ? (out << to_string(repetition_level_histograms)) : (out << "<null>"));
        out << ", " << "definition_level_histograms=";
        (__isset.definition_level_histograms ? (out << to_string(definition_level_histograms)) : (out << "<null>"));
        out << ")";
    }
    ...
    AesGcmV1::AesGcmV1(const AesGcmV1 &other211)
    {
        aad_prefix = other211.aad_prefix;
        aad_file_unique = other211.aad_file_unique;
        supply_aad_prefix = other211.supply_aad_prefix;
        __isset = other211.__isset;
    }
    AesGcmV1 &AesGcmV1::operator=(const AesGcmV1 &other212)
    {
        aad_prefix = other212.aad_prefix;
        aad_file_unique = other212.aad_file_unique;
        supply_aad_prefix = other212.supply_aad_prefix;
    ...
    AesGcmCtrV1::AesGcmCtrV1(const AesGcmCtrV1 &other213)
    {
    ...
    AesGcmCtrV1 &AesGcmCtrV1::operator=(const AesGcmCtrV1 &other214)
    {
    ...
    EncryptionAlgorithm::EncryptionAlgorithm(const EncryptionAlgorithm &other215)
    {
        AES_GCM_V1 = other215.AES_GCM_V1;
        AES_GCM_CTR_V1 = other215.AES_GCM_CTR_V1;
        __isset = other215.__isset;
    }
    EncryptionAlgorithm &EncryptionAlgorithm::operator=(const EncryptionAlgorithm &other216)
    {
        AES_GCM_V1 = other216.AES_GCM_V1;
        AES_GCM_CTR_V1 = other216.AES_GCM_CTR_V1;
    ...
    void FileMetaData::__set_schema(const std::vector<SchemaElement> &val) { this->schema = val; }

    void FileMetaData::__set_num_rows(const int64_t val) { this->num_rows = val; }

    void FileMetaData::__set_row_groups(const std::vector<RowGroup> &val) { this->row_groups = val; }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->schema.resize(_size217);
                        uint32_t _i221;
                        for (_i221 = 0; _i221 < _size217; ++_i221) { xfer += this->schema[_i221].read(iprot); }
                        xfer += iprot->readListEnd();
                    }
                    isset_schema = true;
                } else {
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->row_groups.resize(_size222);
                        uint32_t _i226;
                        for (_i226 = 0; _i226 < _size222; ++_i226) { xfer += this->row_groups[_i226].read(iprot); }
                        xfer += iprot->readListEnd();
                    }
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->key_value_metadata.resize(_size227);
                        uint32_t _i231;
                        for (_i231 = 0; _i231 < _size227; ++_i231) {
                            xfer += this->key_value_metadata[_i231].read(iprot);
                        }
                        xfer += iprot->readListEnd();
                    }
                    this->__isset.key_value_metadata = true;
                ...
                if (ftype == ::apache::thrift::protocol::T_LIST) {
                    {
                        ...
                        this->column_orders.resize(_size232);
                        uint32_t _i236;
                        for (_i236 = 0; _i236 < _size232; ++_i236) { xfer += this->column_orders[_i236].read(iprot); }
                        xfer += iprot->readListEnd();
                    }
    ...
    uint32_t FileMetaData::write(::apache::thrift::protocol::TProtocol *oprot) const
    {
        ...
        xfer += oprot->writeFieldBegin("schema", ::apache::thrift::protocol::T_LIST, 2);
        {
            ...
            std::vector<SchemaElement>::const_iterator _iter237;
            for (_iter237 = this->schema.begin(); _iter237 != this->schema.end(); ++_iter237) {
        ...
        {
            xfer += oprot->writeListBegin(
              ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->row_groups.size()));
            std::vector<RowGroup>::const_iterator _iter238;
            for (_iter238 = this->row_groups.begin(); _iter238 != this->row_groups.end(); ++_iter238) {
        ...
        if (this->__isset.key_value_metadata) {
            xfer += oprot->writeFieldBegin("key_value_metadata", ::apache::thrift::protocol::T_LIST, 5);
            {
                xfer += oprot->writeListBegin(
                  ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->key_value_metadata.size()));
                std::vector<KeyValue>::const_iterator _iter239;
                for (_iter239 = this->key_value_metadata.begin(); _iter239 != this->key_value_metadata.end();
                     ++_iter239) {
        ...
        if (this->__isset.column_orders) {
            ...
            {
                xfer += oprot->writeListBegin(
                  ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->column_orders.size()));
                std::vector<ColumnOrder>::const_iterator _iter240;
                for (_iter240 = this->column_orders.begin(); _iter240 != this->column_orders.end(); ++_iter240) {
    ...
    FileMetaData::FileMetaData(const FileMetaData &other241)
    {
        version = other241.version;
        schema = other241.schema;
        num_rows = other241.num_rows;
        row_groups = other241.row_groups;
        key_value_metadata = other241.key_value_metadata;
        created_by = other241.created_by;
        column_orders = other241.column_orders;
        encryption_algorithm = other241.encryption_algorithm;
        footer_signing_key_metadata = other241.footer_signing_key_metadata;
        __isset = other241.__isset;
    }
    FileMetaData &FileMetaData::operator=(const FileMetaData &other242)
    {
        version = other242.version;
        schema = other242.schema;
        num_rows = other242.num_rows;
        row_groups = other242.row_groups;
        key_value_metadata = other242.key_value_metadata;
        created_by = other242.created_by;
        column_orders = other242.column_orders;
        encryption_algorithm = other242.encryption_algorithm;
        footer_signing_key_metadata = other242.footer_signing_key_metadata;
    ...
    void FileMetaData::printTo(std::ostream &out) const
    {
        ...
        (__isset.encryption_algorithm ? (out << to_string(encryption_algorithm)) : (out << "<null>"));
        out << ", " << "footer_signing_key_metadata=";
        (__isset.footer_signing_key_metadata ? (out << to_string(footer_signing_key_metadata)) : (out << "<null>"));
        out << ")";
    }
    ...
    uint32_t FileCryptoMetaData::read(::apache::thrift::protocol::TProtocol *iprot)
    {
        ...
        if (!isset_encryption_algorithm) throw TProtocolException(TProtocolException::INVALID_DATA);
        return xfer;
    }
    ...
    FileCryptoMetaData::FileCryptoMetaData(const FileCryptoMetaData &other243)
    {
        encryption_algorithm = other243.encryption_algorithm;
        key_metadata = other243.key_metadata;
        __isset = other243.__isset;
    }
    FileCryptoMetaData &FileCryptoMetaData::operator=(const FileCryptoMetaData &other244)
    {
