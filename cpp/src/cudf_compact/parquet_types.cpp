...
MilliSeconds::MilliSeconds(const MilliSeconds& other32) noexcept {
  (void) other32;
}
...
MicroSeconds::MicroSeconds(const MicroSeconds& other34) noexcept {
  (void) other34;
}
...
NanoSeconds::NanoSeconds(const NanoSeconds& other36) noexcept {
  (void) other36;
}
...
JsonType::JsonType(const JsonType& other46) noexcept {
  (void) other46;
}
...
BsonType::BsonType(const BsonType& other48) noexcept {
  (void) other48;
}
...
IndexPageHeader::IndexPageHeader(const IndexPageHeader& other62) noexcept {
  (void) other62;
}
...
SplitBlockAlgorithm::SplitBlockAlgorithm(const SplitBlockAlgorithm& other70) noexcept {
  (void) other70;
}
...
XxHash::XxHash(const XxHash& other74) noexcept {
  (void) other74;
}
...
Uncompressed::Uncompressed(const Uncompressed& other78) noexcept {
  (void) other78;
}
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += this->encoding_stats[_i117].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t ColumnMetaData::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.key_value_metadata) {
    xfer += oprot->writeFieldBegin("key_value_metadata", ::apache::thrift::protocol::T_LIST, 8);
    {
      ...
      for (_iter120 = this->key_value_metadata.begin(); _iter120 != this->key_value_metadata.end(); ++_iter120)
      {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += this->sorting_columns[_i147].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
TypeDefinedOrder::TypeDefinedOrder(const TypeDefinedOrder& other152) noexcept {
  (void) other152;
}
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += this->page_locations[_i162].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t OffsetIndex::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.unencoded_byte_array_data_bytes) {
    xfer += oprot->writeFieldBegin("unencoded_byte_array_data_bytes", ::apache::thrift::protocol::T_LIST, 2);
    {
      ...
      for (_iter169 = this->unencoded_byte_array_data_bytes.begin(); _iter169 != this->unencoded_byte_array_data_bytes.end(); ++_iter169)
      {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += iprot->readBool(this->null_pages[_i176]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += iprot->readI64(this->null_counts[_i192]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t ColumnIndex::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.repetition_level_histograms) {
    xfer += oprot->writeFieldBegin("repetition_level_histograms", ::apache::thrift::protocol::T_LIST, 6);
    {
      ...
      for (_iter207 = this->repetition_level_histograms.begin(); _iter207 != this->repetition_level_histograms.end(); ++_iter207)
      {
  ...
  if (this->__isset.definition_level_histograms) {
    xfer += oprot->writeFieldBegin("definition_level_histograms", ::apache::thrift::protocol::T_LIST, 7);
    {
      ...
      for (_iter208 = this->definition_level_histograms.begin(); _iter208 != this->definition_level_histograms.end(); ++_iter208)
      {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += this->schema[_i221].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          isset_schema = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += this->row_groups[_i226].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += this->column_orders[_i236].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t FileMetaData::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.key_value_metadata) {
    xfer += oprot->writeFieldBegin("key_value_metadata", ::apache::thrift::protocol::T_LIST, 5);
    {
      ...
      for (_iter239 = this->key_value_metadata.begin(); _iter239 != this->key_value_metadata.end(); ++_iter239)
      {
