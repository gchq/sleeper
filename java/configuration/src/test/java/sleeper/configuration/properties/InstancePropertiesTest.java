...
import static sleeper.configuration.properties.CommonProperty.TASK_RUNNER_LAMBDA_MEMORY_IN_MB;
import static sleeper.configuration.properties.CommonProperty.TASK_RUNNER_LAMBDA_TIMEOUT_IN_SECONDS;
import static sleeper.configuration.properties.CommonProperty.VPC_ID;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_EC2_POOL_DESIRED;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_EC2_POOL_MAXIMUM;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_EC2_POOL_MINIMUM;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_EC2_ROOT_SIZE;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_EC2_TYPE;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_ECS_LAUNCHTYPE;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_JOB_CREATION_LAMBDA_MEMORY_IN_MB;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_JOB_CREATION_LAMBDA_PERIOD_IN_MINUTES;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_JOB_CREATION_LAMBDA_TIMEOUT_IN_SECONDS;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_KEEP_ALIVE_PERIOD_IN_SECONDS;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_TASK_ARM_CPU;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_TASK_ARM_MEMORY;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_TASK_CPU_ARCHITECTURE;
import static sleeper.configuration.properties.CompactionProperty.COMPACTION_TASK_CREATION_PERIOD_IN_MINUTES;
...
import static sleeper.configuration.properties.IngestProperty.INGEST_TASK_CREATION_PERIOD_IN_MINUTES;
...
import static sleeper.configuration.properties.PartitionSplittingProperty.FIND_PARTITIONS_TO_SPLIT_LAMBDA_MEMORY_IN_MB;
import static sleeper.configuration.properties.PartitionSplittingProperty.FIND_PARTITIONS_TO_SPLIT_TIMEOUT_IN_SECONDS;
import static sleeper.configuration.properties.PartitionSplittingProperty.SPLIT_PARTITIONS_LAMBDA_MEMORY_IN_MB;
import static sleeper.configuration.properties.PartitionSplittingProperty.SPLIT_PARTITIONS_TIMEOUT_IN_SECONDS;
