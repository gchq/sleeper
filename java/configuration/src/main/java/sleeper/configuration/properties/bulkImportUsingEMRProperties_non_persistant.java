...
public interface bulkImportUsingEMRProperties_non_persistant {
    UserDefinedInstanceProperty DEFAULT_BULK_IMPORT_EMR_RELEASE_LABEL = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.default.bulk.import.emr.release.label")
    ...
    UserDefinedInstanceProperty DEFAULT_BULK_IMPORT_EMR_MASTER_X86_INSTANCE_TYPES = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.default.bulk.import.emr.master.x86.instance.types")
            ...
            .propertyGroup(InstancePropertyGroup.BULK_IMPORT).build();
    UserDefinedInstanceProperty DEFAULT_BULK_IMPORT_EMR_EXECUTOR_X86_INSTANCE_TYPES = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.default.bulk.import.emr.executor.x86.instance.types")
            ...
            .propertyGroup(InstancePropertyGroup.BULK_IMPORT).build();
    UserDefinedInstanceProperty DEFAULT_BULK_IMPORT_EMR_MASTER_ARM_INSTANCE_TYPES = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.default.bulk.import.emr.master.arm.instance.types")
            .description("(Non-persistent EMR mode only) The default EC2 ARM64 instance types to be used for the master " +
                    "node of the EMR cluster. " +
                    "For more information, see the Bulk import using EMR - Instance types section in docs/05-ingest.md")
            .propertyGroup(InstancePropertyGroup.BULK_IMPORT).build();
    UserDefinedInstanceProperty DEFAULT_BULK_IMPORT_EMR_EXECUTOR_ARM_INSTANCE_TYPES = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.default.bulk.import.emr.executor.arm.instance.types")
            .description("(Non-persistent EMR mode only) The default EC2 ARM64 instance types to be used for the executor " +
                    "nodes of the EMR cluster. " +
                    "For more information, see the Bulk import using EMR - Instance types section in docs/05-ingest.md")
            .propertyGroup(InstancePropertyGroup.BULK_IMPORT).build();
    UserDefinedInstanceProperty DEFAULT_BULK_IMPORT_EMR_EXECUTOR_MARKET_TYPE = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.default.bulk.import.emr.executor.market.type")
            ...
            .propertyGroup(InstancePropertyGroup.BULK_IMPORT).build();
    UserDefinedInstanceProperty DEFAULT_BULK_IMPORT_EMR_INITIAL_EXECUTOR_CAPACITY = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.default.bulk.import.emr.executor.initial.instances")
            ...
            .propertyGroup(InstancePropertyGroup.BULK_IMPORT).build();
    UserDefinedInstanceProperty DEFAULT_BULK_IMPORT_EMR_MAX_EXECUTOR_CAPACITY = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.default.bulk.import.emr.executor.max.instances")
