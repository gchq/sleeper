...
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_non_persistant.DEFAULT_BULK_IMPORT_EMR_EXECUTOR_ARM_INSTANCE_TYPES;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_non_persistant.DEFAULT_BULK_IMPORT_EMR_EXECUTOR_MARKET_TYPE;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_non_persistant.DEFAULT_BULK_IMPORT_EMR_EXECUTOR_X86_INSTANCE_TYPES;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_non_persistant.DEFAULT_BULK_IMPORT_EMR_INITIAL_EXECUTOR_CAPACITY;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_non_persistant.DEFAULT_BULK_IMPORT_EMR_MASTER_ARM_INSTANCE_TYPES;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_non_persistant.DEFAULT_BULK_IMPORT_EMR_MASTER_X86_INSTANCE_TYPES;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_non_persistant.DEFAULT_BULK_IMPORT_EMR_MAX_EXECUTOR_CAPACITY;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_non_persistant.DEFAULT_BULK_IMPORT_EMR_RELEASE_LABEL;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_BULK_IMPORT_MIN_LEAF_PARTITION_COUNT;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_COLUMN_INDEX_TRUNCATE_LENGTH;
import static sleeper.configuration.properties.compactionProperties.DEFAULT_COMPACTION_FILES_BATCH_SIZE;
import static sleeper.configuration.properties.compactionProperties.DEFAULT_COMPACTION_STRATEGY_CLASS;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_COMPRESSION_CODEC;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_DICTIONARY_ENCODING_FOR_ROW_KEY_FIELDS;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_DICTIONARY_ENCODING_FOR_SORT_KEY_FIELDS;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_DICTIONARY_ENCODING_FOR_VALUE_FIELDS;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_DYNAMO_POINT_IN_TIME_RECOVERY_ENABLED;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_DYNAMO_STRONGLY_CONSISTENT_READS;
import static sleeper.configuration.properties.garbageCollectionProperties.DEFAULT_GARBAGE_COLLECTOR_DELAY_BEFORE_DELETION;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_INGEST_BATCHER_INGEST_MODE;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_INGEST_BATCHER_MAX_FILE_AGE_SECONDS;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_INGEST_BATCHER_MAX_JOB_FILES;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_INGEST_BATCHER_MAX_JOB_SIZE;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_INGEST_BATCHER_MIN_JOB_FILES;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_INGEST_BATCHER_MIN_JOB_SIZE;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_INGEST_BATCHER_TRACKING_TTL_MINUTES;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_PAGE_SIZE;
import static sleeper.configuration.properties.partitionSplittingProperties.DEFAULT_PARTITION_SPLIT_THRESHOLD;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_ROW_GROUP_SIZE;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_S3A_READAHEAD_RANGE;
import static sleeper.configuration.properties.compactionProperties.DEFAULT_SIZERATIO_COMPACTION_STRATEGY_MAX_CONCURRENT_JOBS_PER_PARTITION;
import static sleeper.configuration.properties.compactionProperties.DEFAULT_SIZERATIO_COMPACTION_STRATEGY_RATIO;
import static sleeper.configuration.properties.defaultProperties.DEFAULT_STATISTICS_TRUNCATE_LENGTH;
