...
public enum SystemDefinedInstanceProperty implements InstanceProperty {
    ...
    COMPACTION_TASK_DEFINITION_FAMILY("sleeper.compaction.task.definition"),
    ...
    SPLITTING_COMPACTION_TASK_DEFINITION_FAMILY("sleeper.compaction.splitting.task.definition"),
