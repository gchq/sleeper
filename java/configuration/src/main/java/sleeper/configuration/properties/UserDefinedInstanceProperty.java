...
/**
 * Sleeper properties set by the user. All non-mandatory properties should be accompanied by a
 * default value and should have a validation predicate for determining if the value a user has
 * provided is valid. By default the predicate always returns true indicating the property is valid.
 */
...
public interface UserDefinedInstanceProperty extends InstanceProperty {
    ...
    UserDefinedInstanceProperty BULK_IMPORT_SPARK_SPECULATION_QUANTILE = named("sleeper.bulk.import.spark.speculation.quantile")
            .description("Fraction of tasks which must be complete before speculation is enabled for a particular stage.\n" +
                    ...
                    "See https://spark.apache.org/docs/latest/configuration.html.")
            .defaultValue("0.75")
            .build(); // This is used to set the value of spark.speculation.quantile on the Spark configuration.
