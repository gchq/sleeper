...
public interface ingestProperties {
    UserDefinedInstanceProperty ECR_INGEST_REPO = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.ingest.repo")
    ...
    UserDefinedInstanceProperty MAXIMUM_CONCURRENT_INGEST_TASKS = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.ingest.max.concurrent.tasks")
            .description("The maximum number of concurrent ECS tasks to run.")
            .defaultValue("200")
            .propertyGroup(InstancePropertyGroup.INGEST).build();
    UserDefinedInstanceProperty INGEST_TASK_CREATION_PERIOD_IN_MINUTES = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.ingest.task.creation.period.minutes")
            ...
            .propertyGroup(InstancePropertyGroup.INGEST)
            .runCDKDeployWhenChanged(true).build();
    UserDefinedInstanceProperty INGEST_KEEP_ALIVE_PERIOD_IN_SECONDS = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.ingest.keepalive.period.seconds")
            ...
            .defaultValue("300")
            .propertyGroup(InstancePropertyGroup.INGEST).build();
    UserDefinedInstanceProperty S3A_INPUT_FADVISE = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.ingest.fs.s3a.experimental.input.fadvise")
            ...
            .propertyGroup(InstancePropertyGroup.INGEST).build();
    UserDefinedInstanceProperty INGEST_TASK_CPU = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.ingest.task.cpu")
            ...
            .propertyGroup(InstancePropertyGroup.INGEST)
            .runCDKDeployWhenChanged(true).build();
    UserDefinedInstanceProperty INGEST_TASK_MEMORY = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.ingest.task.memory")
            ...
            .propertyGroup(InstancePropertyGroup.INGEST)
            .runCDKDeployWhenChanged(true).build();
    UserDefinedInstanceProperty INGEST_PARTITION_REFRESH_PERIOD_IN_SECONDS = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.ingest.partition.refresh.period")
            ...
            .defaultValue("120")
            .propertyGroup(InstancePropertyGroup.INGEST).build();
    UserDefinedInstanceProperty INGEST_SOURCE_BUCKET = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.ingest.source.bucket")
            ...
            .propertyGroup(InstancePropertyGroup.INGEST)
            .runCDKDeployWhenChanged(true).build();
    UserDefinedInstanceProperty INGEST_RECORD_BATCH_TYPE = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.ingest.record.batch.type")
            ...
            .defaultValue("arrow")
            .propertyGroup(InstancePropertyGroup.INGEST).build();
    UserDefinedInstanceProperty INGEST_PARTITION_FILE_WRITER_TYPE = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.ingest.partition.file.writer.type")
