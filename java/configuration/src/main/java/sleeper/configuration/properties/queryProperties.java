...
public interface queryProperties {
    UserDefinedInstanceProperty MAXIMUM_CONNECTIONS_TO_S3_FOR_QUERIES = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.query.s3.max-connections")
    ...
    UserDefinedInstanceProperty QUERY_PROCESSOR_LAMBDA_MEMORY_IN_MB = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.query.processor.memory")
    ...
    UserDefinedInstanceProperty QUERY_PROCESSOR_LAMBDA_TIMEOUT_IN_SECONDS = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.query.processor.timeout.seconds")
            .description("The timeout for the lambda that executes queries in seconds.")
            .defaultValue("900")
            .propertyGroup(InstancePropertyGroup.QUERY)
            .runCDKDeployWhenChanged(true).build();
    UserDefinedInstanceProperty QUERY_PROCESSING_LAMBDA_STATE_REFRESHING_PERIOD_IN_SECONDS = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.query.processor.state.refresh.period.seconds")
            ...
            .defaultValue("60")
            .propertyGroup(InstancePropertyGroup.QUERY).build();
    UserDefinedInstanceProperty QUERY_PROCESSING_LAMBDA_RESULTS_BATCH_SIZE = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.query.processor.results.batch.size")
            ...
            .defaultValue("2000")
            .propertyGroup(InstancePropertyGroup.QUERY).build();
    UserDefinedInstanceProperty QUERY_PROCESSOR_LAMBDA_RECORD_RETRIEVAL_THREADS = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.query.processor.record.retrieval.threads")
            .description("The size of the thread pool for retrieving records in a query processing lambda.")
            .defaultValue("10")
            .validationPredicate(Utils::isPositiveInteger)
            .propertyGroup(InstancePropertyGroup.QUERY).build();
    UserDefinedInstanceProperty QUERY_TRACKER_ITEM_TTL_IN_DAYS = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.query.tracker.ttl.days")
            ...
            .validationPredicate(Utils::isPositiveInteger)
            .propertyGroup(InstancePropertyGroup.QUERY).build();
    UserDefinedInstanceProperty QUERY_RESULTS_BUCKET_EXPIRY_IN_DAYS = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.query.results.bucket.expiry.days")
            .description("The length of time the results of queries remain in the query results bucket before being deleted.")
            .defaultValue("7")
            .validationPredicate(Utils::isPositiveInteger)
            .propertyGroup(InstancePropertyGroup.QUERY)
            .runCDKDeployWhenChanged(true).build();
    UserDefinedInstanceProperty DEFAULT_RESULTS_ROW_GROUP_SIZE = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.default.query.results.rowgroup.size")
            ...
            .propertyGroup(InstancePropertyGroup.QUERY).build();
    UserDefinedInstanceProperty DEFAULT_RESULTS_PAGE_SIZE = UserDefinedInstanceProperty.Index.propertyBuilder("sleeper.default.query.results.page.size")
