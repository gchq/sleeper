...
public class DynamoDBTestUtils {
    ...
    public static Schema createSchema(PrimitiveType primitiveType) {
        return Schema.builder().rowKeyFields(new Field("key", primitiveType)).build();
    }

    public static Schema createSchema() {
        return createSchema(new StringType());
    }
