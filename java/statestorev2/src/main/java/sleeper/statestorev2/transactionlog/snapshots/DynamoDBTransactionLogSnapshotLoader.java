...
public class DynamoDBTransactionLogSnapshotLoader implements TransactionLogSnapshotLoader {
    ...
    private final StateStoreArrowReadFileStore fileStore;
    private final SnapshotType snapshotType;

    public DynamoDBTransactionLogSnapshotLoader(
            DynamoDBTransactionLogSnapshotMetadataStore metadataStore, StateStoreArrowReadFileStore fileStore, SnapshotType snapshotType) {
