...
public class SleeperMetadataHandlerIT extends MetadataHandlerITBase {
    ...
    public void shouldJustReturnLeafPartitionsWhichContainValuesGreaterThanMinKey() throws Exception {
        ...
        // When
        // Make query
        SleeperMetadataHandlerImpl sleeperMetadataHandler = new SleeperMetadataHandlerImpl(S3_CLIENT, DYNAMO_CLIENT, instance.get(CONFIG_BUCKET));

        StateStore stateStore = new StateStoreFactory(instance, S3_CLIENT, DYNAMO_CLIENT, HADOOP_CONF).getStateStore(table);
    ...
    public void shouldCallExtraSchemaEnhancementMethodWhenEnhanceingSchema() throws IOException {
        // Given
        InstanceProperties instance = createInstance();
        SleeperMetadataHandlerImpl handler = new SleeperMetadataHandlerImpl(S3_CLIENT, DYNAMO_CLIENT, instance.get(CONFIG_BUCKET));
