...
public class QueryIngestJobStatusByTaskIdIT extends DynamoDBIngestJobStatusStoreTestBase {
    ...
    public void shouldReturnIngestJobsByTaskId() {
        ...
        store.jobStarted("another-task", job2, startedTime2);
    ...
    public void shouldReturnIngestJobByTaskIdInOneRun() {
        ...
        // When
        store.jobStarted(taskId1, job, startedTime1);
        store.jobStarted(searchingTaskId, job, startedTime2);
        store.jobStarted(taskId3, job, startedTime3);
