...
public class IngestTaskTest {
    ...
    public void shouldRunAndReportTaskWithNoJobs() throws Exception {
        ...
        assertThat(jobStatusStore.getAllJobs(DEFAULT_TABLE_ID)).isEmpty();
    }
    ...
    public void shouldRunAndReportTaskWithOneJobAndNoFiles() throws Exception {
        ...
        assertThat(jobStatusStore.getAllJobs(DEFAULT_TABLE_ID)).containsExactly(
    ...
    private void runTask(IngestJobSource jobs, String taskId, Supplier<Instant> times) throws IteratorException, StateStoreException, IOException {
        runTask(jobs, taskId, jobRunner, times);
    }

    private void runTask(IngestJobSource jobs, String taskId, IngestJobHandler jobRunner, Supplier<Instant> times) throws IteratorException, StateStoreException, IOException {
