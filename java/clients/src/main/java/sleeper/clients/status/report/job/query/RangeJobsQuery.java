...
public class RangeJobsQuery implements JobQuery {
    ...
    public RangeJobsQuery(TableStatus tableId, Instant start, Instant end) {
    ...
    public static JobQuery fromParameters(TableStatus tableId, String queryParameters, Clock clock) {
    ...
    public static JobQuery prompt(TableStatus tableId, ConsoleInput in, Clock clock) {
