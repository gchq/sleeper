...
public class IngestDockerStackV2 {
    private final InstanceProperties instanceProperties;
    private final DynamoDbClient dynamoClient;
    private final SqsClient sqsClient;

    public IngestDockerStackV2(InstanceProperties instanceProperties, DynamoDbClient dynamoClient, SqsClient sqsClient) {
        this.instanceProperties = instanceProperties;
        this.dynamoClient = dynamoClient;
        this.sqsClient = sqsClient;
    }

    public static IngestDockerStackV2 from(
            InstanceProperties instanceProperties,
            DynamoDbClient dynamoClient, SqsClient sqsClient) {
        return new IngestDockerStackV2(instanceProperties, dynamoClient, sqsClient);
    }
