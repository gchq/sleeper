...
public class TableDockerStackV2 {
    private final InstanceProperties instanceProperties;
    private final S3Client s3Client;
    private final DynamoDbClient dynamoDB;

    private TableDockerStackV2(InstanceProperties instanceProperties, S3Client s3Client, DynamoDbClient dynamoDB) {
        this.instanceProperties = instanceProperties;
        this.s3Client = s3Client;
        this.dynamoDB = dynamoDB;
    }

    public static TableDockerStackV2 from(
            InstanceProperties instanceProperties,
            S3Client s3Client, DynamoDbClient dynamoDB) {
        return new TableDockerStackV2(instanceProperties, s3Client, dynamoDB);
    }
