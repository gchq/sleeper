...
public interface SleeperClientIngestBatcherSubmit {

    void submit(IngestBatcherSubmitRequest request);

    static SleeperClientIngestBatcherSubmit toSqs(InstanceProperties instanceProperties, AmazonSQS sqsClient) {
