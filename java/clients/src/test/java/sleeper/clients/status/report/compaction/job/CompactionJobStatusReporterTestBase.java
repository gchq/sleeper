...
public abstract class CompactionJobStatusReporterTestBase {
    ...
    protected static List<CompactionJobStatus> mixedJobStatuses() {
        ...
        CompactionJob job3 = dataHelper.singleFileCompaction(partition("D"));
        Instant creationTime3 = Instant.parse("2022-09-20T13:33:12.001Z");
        Instant startedTime3 = Instant.parse("2022-09-20T13:34:12.001Z");
        CompactionJob job4 = dataHelper.singleFileCompaction(partition("E"));
        Instant creationTime4 = Instant.parse("2022-09-21T13:33:12.001Z");
        CompactionJobStartedStatus started4 = compactionStartedStatus(Instant.parse("2022-09-21T13:34:12.001Z"));
        CompactionJobFinishedStatus finished4 = compactionFinishedStatusUncommitted(summary(started4, Duration.ofMinutes(1), 600, 300));
        CompactionJob job5 = dataHelper.singleFileCompaction(partition("F"));
        Instant creationTime5 = Instant.parse("2022-09-22T13:33:12.001Z");
        CompactionJobStartedStatus started5 = compactionStartedStatus(Instant.parse("2022-09-22T13:34:12.001Z"));
        CompactionJobFinishedStatus finished5 = compactionFinishedStatusUncommitted(summary(started5, Duration.ofMinutes(1), 600, 300));
        CompactionJobCommittedStatus committed5 = compactionCommittedStatus(Instant.parse("2022-09-22T13:36:12.001Z"));
        CompactionJob job6 = dataHelper.singleFileCompaction(partition("G"));
        Instant creationTime6 = Instant.parse("2022-09-23T13:33:12.001Z");
        CompactionJobStartedStatus started6 = compactionStartedStatus(Instant.parse("2022-09-23T13:34:12.001Z"));
        CompactionJobCommittedStatus committed6 = compactionCommittedStatus(Instant.parse("2022-09-23T13:36:12.001Z"));
