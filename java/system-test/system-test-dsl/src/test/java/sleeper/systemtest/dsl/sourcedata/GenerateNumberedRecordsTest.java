...
public class GenerateNumberedRecordsTest {
    ...
    void shouldGenerateTwoRecordsWithStringType() {
        ...
        // When/Then
        assertThat(GenerateNumberedRecords.from(schema).generate(LongStream.of(1, Long.MAX_VALUE)))
                .containsExactly(
                        new Record(Map.of(
    ...
    void shouldGenerateTwoRecordsWithIntType() {
        ...
        // When/Then
        assertThat(GenerateNumberedRecords.from(schema).generate(LongStream.rangeClosed(1, 2)))
                .containsExactly(
                        new Record(Map.of(
                                "rowkey", 1,
                                "sortkey", 1,
    ...
    void shouldOverrideStringGeneratorForOneFieldType() {
        ...
        // When/Then
        assertThat(GenerateNumberedRecords.from(schema, overrides).generate(LongStream.of(1, 999)))
                .containsExactly(
                        new Record(Map.of(
                                "rowkey", "001",
                                "sortkey", "sort-0000000000000000001",
    ...
    void shouldOverrideStringGeneratorForFieldByName() {
        ...
        // When/Then
        assertThat(GenerateNumberedRecords.from(schema, overrides).generate(LongStream.of(1, 12345)))
                .containsExactly(
                        new Record(Map.of(
                                "rowkey", "rowkey-00001",
