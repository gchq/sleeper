...
public class SystemTestSourceFiles {
    ...
    public SystemTestSourceFiles create(String filename, Row... records) {
        return create(filename, Stream.of(records));
    }

    private SystemTestSourceFiles create(String filename, Stream<Row> records) {
        context.writeFile(driver, filename, writeSketches, records);
        return this;
    }

    private SystemTestSourceFiles create(Schema schema, String filename, Stream<Row> records) {
