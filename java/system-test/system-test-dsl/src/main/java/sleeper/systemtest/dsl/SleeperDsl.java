...
import sleeper.systemtest.dsl.ingest.EksBulkImportCheckDsl;
...
public class SleeperDsl {
    ...
    public EksBulkImportCheckDsl eksBulkImportCheck() {
        return new EksBulkImportCheckDsl(context, baseDrivers);
    }
