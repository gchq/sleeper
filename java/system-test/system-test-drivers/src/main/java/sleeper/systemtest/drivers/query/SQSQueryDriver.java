...
public class SQSQueryDriver {
    ...
    public SQSQueryDriver(SleeperInstanceContext instance, AmazonSQS sqsClient, AmazonDynamoDB dynamoDBClient) {
    ...
    public void run(Query query) throws InterruptedException {
