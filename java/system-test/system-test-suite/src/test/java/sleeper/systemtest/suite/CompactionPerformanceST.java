...
import sleeper.systemtest.suite.testutil.Expensive1;
...
@SystemTest
@Expensive1 // Expensive because it takes a long time to compact this many rows on fairly large ECS instances.
