...
import static sleeper.systemtest.suite.testutil.PartitionsTestHelper.create512Partitions;
...
public class EmrBulkImportPerformanceIT {
    ...
    void shouldMeetBulkImportPerformanceStandardsAcrossManyPartitions() throws InterruptedException {
        sleeper.partitioning().setPartitions(create512Partitions(sleeper));
