...
public class CompactSortedFilesRunnerIT {
    ...
    public void shouldDeleteMessages() throws IOException, StateStoreException, ObjectFactoryException, InterruptedException, ActionException {
        ...
        CompactionTaskStatus taskStatus = CompactionTaskStatus.started(Instant.now().toEpochMilli());
        ...
        CompactionJobSerDe jobSerDe = new CompactionJobSerDe(tablePropertiesProvider, taskStatus.getTaskId());
        ...
        CompactSortedFilesRunner runner = new CompactSortedFilesRunner(
                ...
                tablePropertiesProvider, stateStoreProvider, jobStatusStore, taskStatus.getTaskId(),
