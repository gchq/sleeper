...
/**
 * A simple compaction strategy to compact all files over the batch size.
 * <p>
 * Uses {@link sleeper.compaction.strategy.impl.BasicLeafStrategy}.
 *
 * @see sleeper.compaction.strategy.CompactionStrategy
 */
