...
public class CompactionJobStatusFurthestStatusTest {
    ...
    void shouldReportJobUncommitted() {
        ...
        // Then
        assertThat(status.getFurthestRunStatusType()).isEqualTo(UNCOMMITTED);
    }
    ...
    void shouldReportJobSucceededWhenFollowedByAFailedRun() {
        ...
        CompactionJobCommittedStatus committed = compactionCommittedStatus(Instant.parse("2023-03-22T15:36:35Z"));
