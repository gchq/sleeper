...
class JavaCompactionRunnerIT extends CompactionRunnerTestBase {
    ...
    class ProcessStringKey {
        ...
        void shouldGenerateTestData200EvenAndOddStrings() {
            // When
            List<SleeperRow> evens = CompactionRunnerTestData.keyAndTwoValuesSortedEvenStrings();
            List<SleeperRow> odds = CompactionRunnerTestData.keyAndTwoValuesSortedOddStrings();
            List<SleeperRow> combined = CompactionRunnerTestData.combineSortedBySingleKey(evens, odds);
        ...
        void shouldMergeFilesWithStringKey() throws Exception {
            ...
            List<SleeperRow> data1 = CompactionRunnerTestData.keyAndTwoValuesSortedEvenStrings();
            List<SleeperRow> data2 = CompactionRunnerTestData.keyAndTwoValuesSortedOddStrings();
            FileReference file1 = ingestRecordsGetFile(data1);
            FileReference file2 = ingestRecordsGetFile(data2);
    ...
    class ProcessByteArrayKey {
        ...
        void shouldGenerateTestData200EvenAndOddByteArrays() {
            // When
            List<SleeperRow> evens = CompactionRunnerTestData.keyAndTwoValuesSortedEvenByteArrays();
            List<SleeperRow> odds = CompactionRunnerTestData.keyAndTwoValuesSortedOddByteArrays();
            List<SleeperRow> combined = CompactionRunnerTestData.combineSortedBySingleByteArrayKey(evens, odds);
        ...
        void shouldMergeFilesWithByteArrayKey() throws Exception {
            ...
            List<SleeperRow> data1 = CompactionRunnerTestData.keyAndTwoValuesSortedEvenByteArrays();
            List<SleeperRow> data2 = CompactionRunnerTestData.keyAndTwoValuesSortedOddByteArrays();
            FileReference file1 = ingestRecordsGetFile(data1);
            FileReference file2 = ingestRecordsGetFile(data2);
            ...
            // Then
            //  - Read output file and check that it contains the right results
            List<SleeperRow> expectedResults = CompactionRunnerTestData.combineSortedBySingleByteArrayKey(data1, data2);
            assertThat(summary.getRecordsRead()).isEqualTo(expectedResults.size());
            assertThat(summary.getRecordsWritten()).isEqualTo(expectedResults.size());
            assertThat(CompactionRunnerTestData.readDataFile(schema, compactionJob.getOutputFile())).isEqualTo(expectedResults);
        }
