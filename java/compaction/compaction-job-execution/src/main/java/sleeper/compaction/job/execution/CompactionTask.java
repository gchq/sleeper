...
public class CompactionTask {
    ...
    private CompactionJobCommitter jobCompleter;

    public CompactionTask(InstanceProperties instanceProperties, PropertiesReloader propertiesReloader,
            MessageReceiver messageReceiver, CompactionRunner compactor, CompactionJobCommitter jobCompleter,
    ...
    public CompactionTask(InstanceProperties instanceProperties, PropertiesReloader propertiesReloader,
            MessageReceiver messageReceiver, CompactionRunner compactor, CompactionJobCommitter jobCompleter, CompactionJobStatusStore jobStore,
    ...
    private RecordsProcessedSummary compact(CompactionJob job) throws Exception {
        ...
        jobCompleter.apply(new CompactionJobCommitRequest(job, taskId, summary));
