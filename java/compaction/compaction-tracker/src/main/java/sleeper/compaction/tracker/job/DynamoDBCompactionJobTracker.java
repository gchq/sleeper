...
import static sleeper.compaction.tracker.job.DynamoDBCompactionJobStatusFormat.UPDATE_TIME;
import static sleeper.compaction.tracker.job.DynamoDBCompactionJobStatusFormat.createJobCommittedUpdate;
import static sleeper.compaction.tracker.job.DynamoDBCompactionJobStatusFormat.createJobCreated;
import static sleeper.compaction.tracker.job.DynamoDBCompactionJobStatusFormat.createJobFailedUpdate;
import static sleeper.compaction.tracker.job.DynamoDBCompactionJobStatusFormat.createJobFinishedUpdate;
import static sleeper.compaction.tracker.job.DynamoDBCompactionJobStatusFormat.createJobStartedUpdate;
