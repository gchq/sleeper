...
public class SketchesTestData {

    private SketchesTestData() {
    }

    public static final Schema SCHEMA = Schema.builder().rowKeyFields(
    ...
    public static SketchesDeciles createExampleDeciles() {
        return SketchesDeciles.builder()
