...
class EmrPlatformExecutorWiremockIT {
    ...
    void setUp() {
        ...
        instanceProperties.set(BULK_IMPORT_SPARK_NETWORK_TIMEOUT, "800s");
        instanceProperties.set(BULK_IMPORT_SPARK_EXECUTOR_HEARTBEAT_INTERVAL, "60s");
        instanceProperties.set(BULK_IMPORT_EMR_SPARK_DYNAMIC_ALLOCATION_ENABLED, "false");
        instanceProperties.set(BULK_IMPORT_SPARK_MEMORY_FRACTION, "0.80");
        instanceProperties.set(BULK_IMPORT_SPARK_MEMORY_STORAGE_FRACTION, "0.30");
        instanceProperties.set(BULK_IMPORT_SPARK_EXECUTOR_EXTRA_JAVA_OPTIONS,
        ...
        instanceProperties.set(BULK_IMPORT_SPARK_DRIVER_EXTRA_JAVA_OPTIONS,
                "-XX:+UseG1GC -XX:+UnlockDiagnosticVMOptions -XX:+G1SummarizeConcMark -XX:InitiatingHeapOccupancyPercent=35 -verbose:gc -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:OnOutOfMemoryError='kill -9 %p'");
        instanceProperties.set(BULK_IMPORT_EMR_SPARK_YARN_SCHEDULER_REPORTER_THREAD_MAX_FAILURES, "5");
        instanceProperties.set(BULK_IMPORT_SPARK_STORAGE_LEVEL, "MEMORY_AND_DISK_SER");
        instanceProperties.set(BULK_IMPORT_SPARK_RDD_COMPRESS, "true");
        instanceProperties.set(BULK_IMPORT_SPARK_SHUFFLE_COMPRESS, "true");
        instanceProperties.set(BULK_IMPORT_SPARK_SHUFFLE_SPILL_COMPRESS, "true");
