...
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_DRIVER_MEMORY;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_DYNAMIC_ALLOCATION_ENABLED;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_EXECUTOR_CORES;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_EXECUTOR_EXTRA_JAVA_OPTIONS;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_EXECUTOR_HEARTBEAT_INTERVAL;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_EXECUTOR_INSTANCES;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_EXECUTOR_MEMORY;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_MEMORY_FRACTION;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_MEMORY_STORAGE_FRACTION;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_NETWORK_TIMEOUT;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_RDD_COMPRESS;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_SHUFFLE_COMPRESS;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_SHUFFLE_SPILL_COMPRESS;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_SQL_SHUFFLE_PARTITIONS;
import static sleeper.configuration.properties.EMRProperty.BULK_IMPORT_EMR_SPARK_STORAGE_LEVEL;
