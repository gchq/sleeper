...
public class SleeperCdkApp extends Stack {
    ...
    public void create() {
        ...
        AutoDeleteS3ObjectsStack autoDeleteS3ObjectsStackForTable = new AutoDeleteS3ObjectsStack(
        ...
        TableDataStack dataStack = new TableDataStack(this, "TableData", instanceProperties, loggingStack, policiesStack, autoDeleteS3ObjectsStackForTable, jars);
        ...
        AutoDeleteS3ObjectsStack autoDeleteS3ObjectsStackForConfig = new AutoDeleteS3ObjectsStack(
                this, "AutoDeleteS3Objects", instanceProperties, jars,
                loggingStack.getLogGroup(LogGroupRef.CONFIG_AUTODELETE),
                loggingStack.getLogGroup(LogGroupRef.CONFIG_AUTODELETE_PROVIDER));
        ConfigBucketStack configBucketStack = new ConfigBucketStack(this, "Configuration", instanceProperties, loggingStack, policiesStack, autoDeleteS3ObjectsStackForConfig, jars);
