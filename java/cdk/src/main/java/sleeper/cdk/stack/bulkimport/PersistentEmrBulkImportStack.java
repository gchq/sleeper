...
import static sleeper.configuration.properties.BulkImportUsingEMRPropertiesPersistent.BULK_IMPORT_PERSISTENT_EMR_EXECUTOR_ARM_INSTANCE_TYPES;
import static sleeper.configuration.properties.BulkImportUsingEMRPropertiesPersistent.BULK_IMPORT_PERSISTENT_EMR_EXECUTOR_X86_INSTANCE_TYPES;
import static sleeper.configuration.properties.BulkImportUsingEMRPropertiesPersistent.BULK_IMPORT_PERSISTENT_EMR_MASTER_ARM_INSTANCE_TYPES;
import static sleeper.configuration.properties.BulkImportUsingEMRPropertiesPersistent.BULK_IMPORT_PERSISTENT_EMR_MASTER_X86_INSTANCE_TYPES;
import static sleeper.configuration.properties.BulkImportUsingEMRPropertiesPersistent.BULK_IMPORT_PERSISTENT_EMR_MAX_CAPACITY;
import static sleeper.configuration.properties.BulkImportUsingEMRPropertiesPersistent.BULK_IMPORT_PERSISTENT_EMR_MIN_CAPACITY;
import static sleeper.configuration.properties.BulkImportUsingEMRPropertiesPersistent.BULK_IMPORT_PERSISTENT_EMR_RELEASE_LABEL;
import static sleeper.configuration.properties.BulkImportUsingEMRPropertiesPersistent.BULK_IMPORT_PERSISTENT_EMR_STEP_CONCURRENCY_LEVEL;
import static sleeper.configuration.properties.BulkImportUsingEMRPropertiesPersistent.BULK_IMPORT_PERSISTENT_EMR_USE_MANAGED_SCALING;
