...
import static sleeper.configuration.properties.bulkImportUsingEMRProperties.BULK_IMPORT_EMR_EBS_VOLUMES_PER_INSTANCE;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties.BULK_IMPORT_EMR_EBS_VOLUME_SIZE_IN_GB;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties.BULK_IMPORT_EMR_EBS_VOLUME_TYPE;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties.BULK_IMPORT_EMR_EC2_KEYPAIR_NAME;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties.BULK_IMPORT_EMR_MASTER_ADDITIONAL_SECURITY_GROUP;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_persistent.BULK_IMPORT_PERSISTENT_EMR_EXECUTOR_ARM_INSTANCE_TYPES;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_persistent.BULK_IMPORT_PERSISTENT_EMR_EXECUTOR_X86_INSTANCE_TYPES;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_persistent.BULK_IMPORT_PERSISTENT_EMR_MASTER_ARM_INSTANCE_TYPES;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_persistent.BULK_IMPORT_PERSISTENT_EMR_MASTER_X86_INSTANCE_TYPES;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_persistent.BULK_IMPORT_PERSISTENT_EMR_MAX_CAPACITY;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_persistent.BULK_IMPORT_PERSISTENT_EMR_MIN_CAPACITY;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_persistent.BULK_IMPORT_PERSISTENT_EMR_RELEASE_LABEL;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_persistent.BULK_IMPORT_PERSISTENT_EMR_STEP_CONCURRENCY_LEVEL;
import static sleeper.configuration.properties.bulkImportUsingEMRProperties_persistent.BULK_IMPORT_PERSISTENT_EMR_USE_MANAGED_SCALING;
