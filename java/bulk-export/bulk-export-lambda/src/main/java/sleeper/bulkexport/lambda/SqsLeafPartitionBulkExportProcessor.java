...
import sleeper.core.properties.instance.BulkExportProperty;
 ...
 */
public class SqsLeafPartitionBulkExportProcessor {
    private static final Logger LOGGER = LoggerFactory.getLogger(SqsLeafPartitionBulkExportProcessor.class);
    ...
    private SqsLeafPartitionBulkExportProcessor(Builder builder) throws ObjectFactoryException {
     ...
     */
    public void processExport(BulkExportLeafPartitionQuery bulkExportLeafPartitionQuery) throws ObjectFactoryException {
        TableProperties tableProperties = tablePropertiesProvider.getById(bulkExportLeafPartitionQuery.getTableId());
        StateStore statestore = stateStoreProvider.getStateStore(tableProperties);
        String language = instanceProperties.get(BulkExportProperty.BULK_EXPORT_LEAF_PARTITION_LANGUAGE);
        LOGGER.info("Processing bulk export query for table: {} using the {} processor", tableProperties.get(TableProperty.TABLE_NAME), language);      
    }
    ...
    public static final class Builder {
         ...
         *
         * @return A new instance of {@link SqsLeafPartitionBulkExportProcessor}.
         * @throws ObjectFactoryException If there is an error during the creation of the {@link SqsLeafPartitionBulkExportProcessor} instance.
         */
        public SqsLeafPartitionBulkExportProcessor build() throws ObjectFactoryException {
            return new SqsLeafPartitionBulkExportProcessor(this);
        }
    }
}
