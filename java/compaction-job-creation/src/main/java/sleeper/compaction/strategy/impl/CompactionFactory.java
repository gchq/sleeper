...
public class CompactionFactory {
    ...
    public CompactionJob createSplittingCompactionJob(
        ...
        return createSplittingCompaction(
                ...
                splitPoint, dimension)
                .buildJob();
    }

    public CreateCompactionJob createSplittingCompaction(
            List<FileInfo> files, String partition, String leftPartitionId, String rightPartitionId,
            Object splitPoint, int dimension) {
    ...
    public CompactionJob createCompactionJob(
        ...
        return createCompaction(files, partition).buildJob();
    }

    public CreateCompactionJob createCompaction(
            List<FileInfo> files, String partition) {
    ...
    public CreateCompactionJob.Builder createJob() {
