...
public class AutoStopEmrServerlessApplicationStack extends NestedStack {
    ...
    public AutoStopEmrServerlessApplicationStack(Construct scope, String id, InstanceProperties instanceProperties, ISleeperArtefacts artefacts,
    ...
    private void createLambda(InstanceProperties instanceProperties, ISleeperArtefacts artefacts, LoggingStack loggingStack) {
