...
public class AutoDeleteS3ObjectsStack extends NestedStack {
    ...
    public AutoDeleteS3ObjectsStack(Construct scope, String id, InstanceProperties instanceProperties, SleeperJarVersionIdsCache jars, LoggingStack loggingStack) {
        super(scope, id);
    ...
    public AutoDeleteS3ObjectsStack(Construct scope, String id, InstanceProperties instanceProperties, SleeperJarVersionIdsCache jars) {
        super(scope, id);
    ...
    private void createLambda(InstanceProperties instanceProperties, SleeperJarVersionIdsCache jars, ILogGroup logGroup, ILogGroup providerLogGroup) {
