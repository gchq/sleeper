...
public class EcsClusterTasksStack extends NestedStack {
    ...
    public EcsClusterTasksStack(Construct scope, String id, InstanceProperties instanceProperties, SleeperInstanceArtefacts artefacts, LoggingStack loggingStack) {
        super(scope, id);
    ...
    public EcsClusterTasksStack(Construct scope, String id, InstanceProperties instanceProperties, SleeperInstanceArtefacts artefacts) {
        super(scope, id);
        createEcsSecurityGroup(this, instanceProperties);
    ...
    private void createAutoStopLambda(InstanceProperties instanceProperties, SleeperInstanceArtefacts artefacts, ILogGroup logGroup, ILogGroup providerLogGroup) {

        SleeperLambdaCode lambdaCode = artefacts.lambdaCodeAtScope(this);

        String functionName = String.join("-", "sleeper",
                instanceProperties.cleanInstanceId(), "auto-stop-ecs-cluster-tasks");
     ...
     */
    public CustomResource addAutoStopEcsClusterTasksAfterTaskCreatorIsDeleted(Construct scope, ICluster cluster, IFunction taskCreator) {
