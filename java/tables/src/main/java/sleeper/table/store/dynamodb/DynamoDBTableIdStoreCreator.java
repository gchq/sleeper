...
import static sleeper.table.store.dynamodb.DynamoDBTableIdFormat.TABLE_ID_FIELD;
import static sleeper.table.store.dynamodb.DynamoDBTableIdFormat.TABLE_NAME_FIELD;
