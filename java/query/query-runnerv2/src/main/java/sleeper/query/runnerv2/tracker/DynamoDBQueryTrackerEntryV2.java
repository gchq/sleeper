 ...
 */
class DynamoDBQueryTrackerEntryV2 {
    ...
    private DynamoDBQueryTrackerEntryV2(Builder builder) {
    ...
    public DynamoDBQueryTrackerEntryV2 updateParent(QueryState state, long totalRecordCount) {
        return builder()
                .queryId(queryId)
                .state(state)
    ...
    static final class Builder {
        ...
        public DynamoDBQueryTrackerEntryV2 build() {
            return new DynamoDBQueryTrackerEntryV2(this);
        }
    }
}
