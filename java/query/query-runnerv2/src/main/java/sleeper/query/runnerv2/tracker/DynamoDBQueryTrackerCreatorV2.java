...
import static sleeper.query.runnerv2.tracker.DynamoDBQueryTracker.SUB_QUERY_ID;

public class DynamoDBQueryTrackerCreatorV2 {
    private final InstanceProperties instanceProperties;
    private final DynamoDbClient dynamoClient;

    public DynamoDBQueryTrackerCreatorV2(InstanceProperties instanceProperties, DynamoDbClient dynamoClient) {
