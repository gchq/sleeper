...
public class WebSocketResultsOutputIT {
    ...
    public void shouldStopPublishingResultsWhenClientHasGone(WireMockRuntimeInfo wmRuntimeInfo) {
        ...
        records.add(new Row(Collections.singletonMap("id", "record1")));
        records.add(new Row(Collections.singletonMap("id", "record2")));
        records.add(new Row(Collections.singletonMap("id", "record3")));
        records.add(new Row(Collections.singletonMap("id", "record4")));
        records.add(new Row(Collections.singletonMap("id", "record5")));
