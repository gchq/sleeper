...
public class QueryExecutorTest {
    ...
    class QueryRecords {
        ...
        void shouldReturnSubRangeInSinglePartition() throws Exception {
            ...
            // When
            List<SleeperRow> records = getRecords(queryRange(100L, 200L));

            // Then
            assertThat(records).containsExactly(new SleeperRow(Map.of("key", 123L)));
        }
        ...
        void shouldReturnRecordInOneOfTwoRanges() throws Exception {
            ...
            // When
            List<SleeperRow> records = getRecords(queryRegions(range(100L, 200L), range(400L, 500L)));
        ...
        void shouldNotFindRecordOutsideSubRangeInSinglePartition() throws Exception {
            ...
            // When
            List<SleeperRow> records = getRecords(queryRange(200L, 300L));
        ...
        void shouldNotFindRecordOutsidePartitionRangeWhenFileContainsAnInactiveRecord() throws Exception {
            ...
            // When
            List<SleeperRow> records = getRecords(queryAllRecords());
    ...
    class RequestValueFields {
        ...
        void shouldExcludeFieldsWhenRequestingValueFields() throws Exception {
            ...
            // When
            List<SleeperRow> records = getRecords(queryAllRecordsBuilder()
                    .processingConfig(requestValueFields("A"))
                    .build());

            // Then
            assertThat(records).containsExactly(
                    new SleeperRow(Map.of("key", 1L, "A", "first")));
        }
    }
    ...
    class ApplyIterators {
        ...
        void setUp() throws Exception {
            ...
            update(stateStore).initialise(new PartitionsBuilder(schema).singlePartition("root").buildList());
            addRootFile("file.parquet", List.of(
                    new SleeperRow(Map.of("key", "A", "value", 2L)),
                    new SleeperRow(Map.of("key", "A", "value", 2L)),
                    new SleeperRow(Map.of("key", "B", "value", 3L)),
                    new SleeperRow(Map.of("key", "B", "value", 4L))));
        }
        ...
        void shouldApplyTableIterator() throws Exception {
            ...
            // Then
            assertThat(records).containsExactly(
                    new SleeperRow(Map.of("key", "A", "value", 4L)),
                    new SleeperRow(Map.of("key", "B", "value", 7L)));
        }
    ...
    class ReinitialiseOnTimeout {
        ...
        public void shouldReloadActiveFilesFromStateStoreWhenTimedOut() throws Exception {
            ...
            assertThat(getRecords(queryExecutor, queryAllRecords()))
                    .containsExactly(new SleeperRow(Map.of("key", 123L)));
        }
    ...
    private List<SleeperRow> getRecords(Query query) throws Exception {
        return getRecords(executor(), query);
    }

    private List<SleeperRow> getRecords(QueryExecutor executor, Query query) {
