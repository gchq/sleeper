...
public class LeafPartitionQueryTest {
    ...
    public void testEqualsAndHashcode() {
        ...
        Region partitionRegion1 = Region.from(partitionRange1);
        Region partitionRegion2 = Region.from(partitionRange2);
        Region partitionRegion3 = Region.from(partitionRange3);
