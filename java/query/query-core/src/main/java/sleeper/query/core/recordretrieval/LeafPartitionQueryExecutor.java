...
public class LeafPartitionQueryExecutor {
    ...
    public CloseableIterator<Row> getRecords(LeafPartitionQuery leafPartitionQuery) throws QueryException {
        ...
        try {
            CloseableIterator<Row> iterator = retriever.getRecords(leafPartitionQuery, dataReadSchema);
