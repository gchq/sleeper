...
public class SqsLeafPartitionQueryProcessor {
    ...
    public void processQuery(LeafPartitionQuery leafPartitionQuery) {
        ...
        try {
            ...
            CloseableIterator<SleeperRow> results = leafPartitionQueryExecutor.getRecords(leafPartitionQuery);
    ...
    private void publishResults(CloseableIterator<SleeperRow> results, QueryOrLeafPartitionQuery query, TableProperties tableProperties, QueryStatusReportListeners queryTrackers) {
        try {
