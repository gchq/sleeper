...
public class StateStoreCommitRequestByTransaction {
    ...
    private StateStoreCommitRequestByTransaction(String tableId, TransactionType transactionType, String bodyKey) {
    ...
    public static StateStoreCommitRequestByTransaction create(String tableId, String bodyKey, StateStoreTransaction<?> transaction) {
        return new StateStoreCommitRequestByTransaction(tableId, TransactionType.getType(transaction), bodyKey);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(tableId, transactionType, bodyKey);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(tableId, other.tableId) && transactionType == other.transactionType && Objects.equals(bodyKey, other.bodyKey);
    }

    @Override
    public String toString() {
        return "StateStoreCommitRequestByTransactionInS3{tableId=" + tableId + ", transactionType=" + transactionType + ", bodyKey=" + bodyKey + "}";
    }
