...
public class StateStoreProvider {
     ...
     * managed explicitly by calling methods on the provider. Note that {@link #ensureEnoughHeapSpaceAvailable} will not
     * have a target amount of space, so will never free any space.
     *
