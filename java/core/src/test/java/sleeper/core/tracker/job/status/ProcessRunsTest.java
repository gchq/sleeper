...
import static sleeper.core.tracker.job.status.CustomProcessStatus.notPartOfRunWithUpdateTime;
import static sleeper.core.tracker.job.status.CustomProcessStatus.partOfRunWithUpdateTime;
import static sleeper.core.tracker.job.status.ProcessRunsTestHelper.runsFromUpdates;
import static sleeper.core.tracker.job.status.ProcessStartedStatusWithStartOfRunFlag.startedStatusNotStartOfRun;
...
import static sleeper.core.tracker.job.status.TestProcessStatusUpdateRecords.TASK_ID_1;
import static sleeper.core.tracker.job.status.TestProcessStatusUpdateRecords.TASK_ID_2;
import static sleeper.core.tracker.job.status.TestProcessStatusUpdateRecords.forJobRunOnTask;
...
import static sleeper.core.tracker.job.status.TestProcessStatusUpdateRecords.onNoTask;
import static sleeper.core.tracker.job.status.TestProcessStatusUpdateRecords.onTask;
