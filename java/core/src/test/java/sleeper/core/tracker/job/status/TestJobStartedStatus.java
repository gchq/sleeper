...
public class TestJobStartedStatus implements JobRunStartedUpdate {
    ...
    private TestJobStartedStatus(Instant updateTime, Instant startTime) {
     ...
     */
    public static TestJobStartedStatus updateAndStartTime(Instant updateTime, Instant startTime) {
        return new TestJobStartedStatus(updateTime, startTime);
    }
    ...
    public boolean equals(Object o) {
        ...
        TestJobStartedStatus that = (TestJobStartedStatus) o;
