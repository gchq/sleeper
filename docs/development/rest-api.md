...
[docs/rest-api/openapi.yaml](../usage/rest-api/openapi.yaml). The committed file is **auto-generated**
...
- The `Route` interface at [Route.java](../../java/rest-api/src/main/java/sleeper/restapi/Route.java) —
  ...
  contributes.
- The generator at [GenerateOpenApiSpec.java](../../java/rest-api/src/main/java/sleeper/restapi/GenerateOpenApiSpec.java)
...
2. Implement `openApiMethod`, `openApiPath`, `openApiOperation`, and optionally `openApiSchemas`
   ...
   canonical example.
3. Add a prose companion page under [docs/rest-api/](../usage/rest-api/) with a worked example, and
...
[docs/rest-api/openapi.yaml](../usage/rest-api/openapi.yaml). You can also invoke the generator alone
