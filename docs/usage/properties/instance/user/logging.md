...
| sleeper.logging.level.apache  | The logging level for Apache logs that are not Parquet.                                                              | INFO          | true                        |
| sleeper.logging.level.parquet | The logging level for Parquet logs.                                                                                  | WARN          | true                        |
| sleeper.logging.level.aws     | The logging level for AWS logs.                                                                                      | INFO          | true                        |
| sleeper.logging.level.root    | The logging level for everything else.                                                                               | INFO          | true                        |
