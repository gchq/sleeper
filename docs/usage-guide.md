...
This will assume you have a deployed instance of Sleeper, and you've installed or built Sleeper and its dependencies as
...
There are clients and scripts in the `scripts/deploy`, `scripts/report`, `scripts/table`, and `scripts/utility` directories that can be used to work with an
existing instance.
